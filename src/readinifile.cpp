...
void process_read_ini_file()
{
    ...
    for (Index2 = 0; Index2 < 19; Index2++) {
        XPSetWidgetProperty(SwitchDisableCheckWidget[Index2],
            xpProperty_ButtonState, 0);
        XPSetWidgetProperty(SwitchEnableCheckWidget[Index2],
            xpProperty_ButtonState, 0);
        XPSetWidgetProperty(SwitchRemapCheckWidget[Index2],
            xpProperty_ButtonState, 0);
    }
    ...
    if ((magoffswitchenable == 3) || (magoffswitchenable == 4)) {
        ...
        mag_off10_switch_data_on_value =
    ...
    if ((magrightswitchenable == 3) || (magrightswitchenable == 4)) {
        ...
        mag_right_switch_data_on_value =
            getOptionToInt("mag_right_switch_data_on_value");
        mag_right_switch_data_off_value =
            getOptionToInt("mag_right_switch_data_off_value");
        ...
        mag_right2_switch_data_on_value =
            getOptionToInt("mag_right2_switch_data_on_value");
        mag_right2_switch_data_off_value =
            getOptionToInt("mag_right2_switch_data_off_value");
        ...
        mag_right3_switch_data_on_value =
            getOptionToInt("mag_right3_switch_data_on_value");
        mag_right3_switch_data_off_value =
            getOptionToInt("mag_right3_switch_data_off_value");
        ...
        mag_right4_switch_data_on_value =
            getOptionToInt("mag_right4_switch_data_on_value");
        mag_right4_switch_data_off_value =
            getOptionToInt("mag_right4_switch_data_off_value");
        ...
        mag_right5_switch_data_on_value =
            getOptionToInt("mag_right5_switch_data_on_value");
        mag_right5_switch_data_off_value =
            getOptionToInt("mag_right5_switch_data_off_value");
        ...
        mag_right6_switch_data_on_value =
            getOptionToInt("mag_right6_switch_data_on_value");
        mag_right6_switch_data_off_value =
            getOptionToInt("mag_right6_switch_data_off_value");
        ...
        mag_right7_switch_data_on_value =
            getOptionToInt("mag_right7_switch_data_on_value");
        mag_right7_switch_data_off_value =
            getOptionToInt("mag_right7_switch_data_off_value");
        ...
        mag_right8_switch_data_on_value =
            getOptionToInt("mag_right8_switch_data_on_value");
        mag_right8_switch_data_off_value =
            getOptionToInt("mag_right8_switch_data_off_value");
        ...
        mag_right9_switch_data_on_value =
            getOptionToInt("mag_right9_switch_data_on_value");
        mag_right9_switch_data_off_value =
            getOptionToInt("mag_right9_switch_data_off_value");

        mag_right10_switch_data =
            getOptionToString("mag_right10_switch_data");
        MagRight10SwitchData =
            XPLMFindDataRef(mag_right10_switch_data.c_str());
    ...
    if ((magleftswitchenable == 3) || (magleftswitchenable == 4)) {
        ...
        mag_left_switch_data_on_value =
            getOptionToInt("mag_left_switch_data_on_value");
        mag_left_switch_data_off_value =
            getOptionToInt("mag_left_switch_data_off_value");
        ...
        mag_left2_switch_data_on_value =
            getOptionToInt("mag_left2_switch_data_on_value");
        mag_left2_switch_data_off_value =
            getOptionToInt("mag_left2_switch_data_off_value");
        ...
        mag_left3_switch_data_on_value =
            getOptionToInt("mag_left3_switch_data_on_value");
        mag_left3_switch_data_off_value =
            getOptionToInt("mag_left3_switch_data_off_value");
        ...
        mag_left4_switch_data_on_value =
            getOptionToInt("mag_left4_switch_data_on_value");
        mag_left4_switch_data_off_value =
            getOptionToInt("mag_left4_switch_data_off_value");
        ...
        mag_left5_switch_data_on_value =
            getOptionToInt("mag_left5_switch_data_on_value");
        mag_left5_switch_data_off_value =
            getOptionToInt("mag_left5_switch_data_off_value");
        ...
        mag_left6_switch_data_on_value =
            getOptionToInt("mag_left6_switch_data_on_value");
        mag_left6_switch_data_off_value =
            getOptionToInt("mag_left6_switch_data_off_value");
        ...
        mag_left7_switch_data_on_value =
            getOptionToInt("mag_left7_switch_data_on_value");
        mag_left7_switch_data_off_value =
            getOptionToInt("mag_left7_switch_data_off_value");
        ...
        mag_left8_switch_data_on_value =
            getOptionToInt("mag_left8_switch_data_on_value");
        mag_left8_switch_data_off_value =
            getOptionToInt("mag_left8_switch_data_off_value");
        ...
        mag_left9_switch_data_on_value =
            getOptionToInt("mag_left9_switch_data_on_value");
        mag_left9_switch_data_off_value =
            getOptionToInt("mag_left9_switch_data_off_value");
    ...
    if ((magbothswitchenable == 3) || (magbothswitchenable == 4)) {
        ...
        mag_both_switch_data_on_value =
            getOptionToInt("mag_both_switch_data_on_value");
        mag_both_switch_data_off_value =
            getOptionToInt("mag_both_switch_data_off_value");
        ...
        mag_both2_switch_data_on_value =
            getOptionToInt("mag_both2_switch_data_on_value");
        mag_both2_switch_data_off_value =
            getOptionToInt("mag_both2_switch_data_off_value");
        ...
        mag_both3_switch_data_on_value =
            getOptionToInt("mag_both3_switch_data_on_value");
        mag_both3_switch_data_off_value =
            getOptionToInt("mag_both3_switch_data_off_value");
        ...
        mag_both4_switch_data_on_value =
            getOptionToInt("mag_both4_switch_data_on_value");
        mag_both4_switch_data_off_value =
            getOptionToInt("mag_both4_switch_data_off_value");
        ...
        mag_both5_switch_data_on_value =
            getOptionToInt("mag_both5_switch_data_on_value");
        mag_both5_switch_data_off_value =
            getOptionToInt("mag_both5_switch_data_off_value");
        ...
        mag_both6_switch_data_on_value =
            getOptionToInt("mag_both6_switch_data_on_value");
        mag_both6_switch_data_off_value =
            getOptionToInt("mag_both6_switch_data_off_value");
        ...
        mag_both7_switch_data_on_value =
            getOptionToInt("mag_both7_switch_data_on_value");
        mag_both7_switch_data_off_value =
            getOptionToInt("mag_both7_switch_data_off_value");
        ...
        mag_both8_switch_data_on_value =
            getOptionToInt("mag_both8_switch_data_on_value");
        mag_both8_switch_data_off_value =
            getOptionToInt("mag_both8_switch_data_off_value");
        ...
        mag_both9_switch_data_on_value =
            getOptionToInt("mag_both9_switch_data_on_value");
        mag_both9_switch_data_off_value =
            getOptionToInt("mag_both9_switch_data_off_value");
    ...
    if ((magstartswitchenable == 3) || (magstartswitchenable == 4)) {
        ...
        mag_start_switch_data_on_value =
            getOptionToInt("mag_start_switch_data_on_value");
        mag_start_switch_data_off_value =
            getOptionToInt("mag_start_switch_data_off_value");

        mag_start_switch_left_data =
            getOptionToString("mag_start_switch_left_data");
        MagStartSwitchLeftData =
            XPLMFindDataRef(mag_start_switch_left_data.c_str());
        mag_start_switch_left_data_on_value =
            getOptionToInt("mag_start_switch_left_data_on_value");
        ...
        mag_start2_switch_data_on_value =
            getOptionToInt("mag_start2_switch_data_on_value");
        mag_start2_switch_data_off_value =
            getOptionToInt("mag_start2_switch_data_off_value");

        mag_start2_switch_left_data =
            getOptionToString("mag_start2_switch_left_data");
        MagStart2SwitchLeftData =
            XPLMFindDataRef(mag_start2_switch_left_data.c_str());
        ...
        mag_start3_switch_data_on_value =
            getOptionToInt("mag_start3_switch_data_on_value");
        mag_start3_switch_data_off_value =
            getOptionToInt("mag_start3_switch_data_off_value");

        mag_start3_switch_left_data =
            getOptionToString("mag_start3_switch_left_data");
        MagStart3SwitchLeftData =
            XPLMFindDataRef(mag_start3_switch_left_data.c_str());
        mag_start3_switch_left_data_on_value =
            getOptionToInt("mag_start3_switch_left_data_on_value");
        ...
        mag_start4_switch_data_on_value =
            getOptionToInt("mag_start4_switch_data_on_value");
        mag_start4_switch_data_off_value =
            getOptionToInt("mag_start4_switch_data_off_value");

        mag_start4_switch_left_data =
            getOptionToString("mag_start4_switch_left_data");
        MagStart4SwitchLeftData =
            XPLMFindDataRef(mag_start4_switch_left_data.c_str());
        ...
        mag_start5_switch_data_on_value =
            getOptionToInt("mag_start5_switch_data_on_value");
        mag_start5_switch_data_off_value =
            getOptionToInt("mag_start5_switch_data_off_value");

        mag_start5_switch_left_data =
            getOptionToString("mag_start5_switch_left_data");
        MagStart5SwitchLeftData =
            XPLMFindDataRef(mag_start5_switch_left_data.c_str());
        mag_start5_switch_left_data_on_value =
            getOptionToInt("mag_start5_switch_left_data_on_value");
        ...
        mag_start6_switch_data_on_value =
            getOptionToInt("mag_start6_switch_data_on_value");
        mag_start6_switch_data_off_value =
            getOptionToInt("mag_start6_switch_data_off_value");

        mag_start6_switch_left_data =
            getOptionToString("mag_start6_switch_left_data");
        MagStart6SwitchLeftData =
            XPLMFindDataRef(mag_start6_switch_left_data.c_str());
        ...
        mag_start7_switch_data_on_value =
            getOptionToInt("mag_start7_switch_data_on_value");
        mag_start7_switch_data_off_value =
            getOptionToInt("mag_start7_switch_data_off_value");

        mag_start7_switch_left_data =
            getOptionToString("mag_start7_switch_left_data");
        MagStart7SwitchLeftData =
            XPLMFindDataRef(mag_start7_switch_left_data.c_str());
        mag_start7_switch_left_data_on_value =
            getOptionToInt("mag_start7_switch_left_data_on_value");
        ...
        mag_start8_switch_data_on_value =
            getOptionToInt("mag_start8_switch_data_on_value");
        mag_start8_switch_data_off_value =
            getOptionToInt("mag_start8_switch_data_off_value");

        mag_start8_switch_left_data =
            getOptionToString("mag_start8_switch_left_data");
        MagStart8SwitchLeftData =
            XPLMFindDataRef(mag_start8_switch_left_data.c_str());
        mag_start8_switch_left_data_on_value =
            getOptionToInt("mag_start8_switch_left_data_on_value");
        ...
        mag_start9_switch_data_on_value =
            getOptionToInt("mag_start9_switch_data_on_value");
        mag_start9_switch_data_off_value =
            getOptionToInt("mag_start9_switch_data_off_value");

        mag_start9_switch_left_data =
            getOptionToString("mag_start9_switch_left_data");
        MagStart9SwitchLeftData =
            XPLMFindDataRef(mag_start9_switch_left_data.c_str());
        ...
        MagStart10SwitchData =
            XPLMFindDataRef(mag_start10_switch_data.c_str());
        mag_start10_switch_data_on_value =
            getOptionToInt("mag_start10_switch_data_on_value");
        mag_start10_switch_data_off_value =
            getOptionToInt("mag_start10_switch_data_off_value");

        mag_start10_switch_left_data =
            getOptionToString("mag_start10_switch_left_data");
        MagStart10SwitchLeftData =
            XPLMFindDataRef(mag_start10_switch_left_data.c_str());
        mag_start10_switch_left_data_on_value =
            getOptionToInt("mag_start10_switch_left_data_on_value");
        mag_start10_switch_left_data_off_value =
            getOptionToInt("mag_start10_switch_left_data_off_value");
    ...
    if ((batmasterswitchenable == 3) || (batmasterswitchenable == 4)) {
        ...
        bat_master_switch_data_on_value =
            getOptionToInt("bat_master_switch_data_on_value");
        bat_master_switch_data_off_value =
            getOptionToInt("bat_master_switch_data_off_value");

        bat2_master_switch_data =
            getOptionToString("bat2_master_switch_data");
        Bat2MasterSwitchData =
            XPLMFindDataRef(bat2_master_switch_data.c_str());
        bat2_master_switch_data_on_value =
            getOptionToInt("bat2_master_switch_data_on_value");
        bat2_master_switch_data_off_value =
            getOptionToInt("bat2_master_switch_data_off_value");

        bat3_master_switch_data =
            getOptionToString("bat3_master_switch_data");
        Bat3MasterSwitchData =
            XPLMFindDataRef(bat3_master_switch_data.c_str());
        bat3_master_switch_data_on_value =
            getOptionToInt("bat3_master_switch_data_on_value");
        bat3_master_switch_data_off_value =
            getOptionToInt("bat3_master_switch_data_off_value");

        bat4_master_switch_data =
            getOptionToString("bat4_master_switch_data");
        Bat4MasterSwitchData =
            XPLMFindDataRef(bat4_master_switch_data.c_str());
        bat4_master_switch_data_on_value =
            getOptionToInt("bat4_master_switch_data_on_value");
        bat4_master_switch_data_off_value =
            getOptionToInt("bat4_master_switch_data_off_value");

        bat5_master_switch_data =
            getOptionToString("bat5_master_switch_data");
        Bat5MasterSwitchData =
            XPLMFindDataRef(bat5_master_switch_data.c_str());
        bat5_master_switch_data_on_value =
            getOptionToInt("bat5_master_switch_data_on_value");
        bat5_master_switch_data_off_value =
            getOptionToInt("bat5_master_switch_data_off_value");

        bat6_master_switch_data =
            getOptionToString("bat6_master_switch_data");
        Bat6MasterSwitchData =
            XPLMFindDataRef(bat6_master_switch_data.c_str());
        bat6_master_switch_data_on_value =
            getOptionToInt("bat6_master_switch_data_on_value");
        bat6_master_switch_data_off_value =
            getOptionToInt("bat6_master_switch_data_off_value");

        bat7_master_switch_data =
            getOptionToString("bat7_master_switch_data");
        Bat7MasterSwitchData =
            XPLMFindDataRef(bat7_master_switch_data.c_str());
        bat7_master_switch_data_on_value =
            getOptionToInt("bat7_master_switch_data_on_value");
        bat7_master_switch_data_off_value =
            getOptionToInt("bat7_master_switch_data_off_value");

        bat8_master_switch_data =
            getOptionToString("bat8_master_switch_data");
        Bat8MasterSwitchData =
            XPLMFindDataRef(bat8_master_switch_data.c_str());
    ...
    if (altmasterswitchenable == 2) {
        ...
        AltMasterSwitchOffCmd =
            XPLMFindCommand(alt_master_switch_off.c_str());
    }
    ...
    if ((altmasterswitchenable == 3) || (altmasterswitchenable == 4)) {
        ...
        alt_master_switch_data_on_value =
            getOptionToInt("alt_master_switch_data_on_value");
        alt_master_switch_data_off_value =
            getOptionToInt("alt_master_switch_data_off_value");

        alt2_master_switch_data =
            getOptionToString("alt2_master_switch_data");
        Alt2MasterSwitchData =
            XPLMFindDataRef(alt2_master_switch_data.c_str());
        alt2_master_switch_data_on_value =
            getOptionToInt("alt2_master_switch_data_on_value");
        alt2_master_switch_data_off_value =
            getOptionToInt("alt2_master_switch_data_off_value");

        alt3_master_switch_data =
            getOptionToString("alt3_master_switch_data");
        Alt3MasterSwitchData =
            XPLMFindDataRef(alt3_master_switch_data.c_str());
        alt3_master_switch_data_on_value =
            getOptionToInt("alt3_master_switch_data_on_value");
        alt3_master_switch_data_off_value =
            getOptionToInt("alt3_master_switch_data_off_value");

        alt4_master_switch_data =
            getOptionToString("alt4_master_switch_data");
        Alt4MasterSwitchData =
            XPLMFindDataRef(alt4_master_switch_data.c_str());
        alt4_master_switch_data_on_value =
            getOptionToInt("alt4_master_switch_data_on_value");
        alt4_master_switch_data_off_value =
            getOptionToInt("alt4_master_switch_data_off_value");

        alt5_master_switch_data =
            getOptionToString("alt5_master_switch_data");
        Alt5MasterSwitchData =
            XPLMFindDataRef(alt5_master_switch_data.c_str());
        alt5_master_switch_data_on_value =
            getOptionToInt("alt5_master_switch_data_on_value");
        alt5_master_switch_data_off_value =
            getOptionToInt("alt5_master_switch_data_off_value");

        alt6_master_switch_data =
            getOptionToString("alt6_master_switch_data");
        Alt6MasterSwitchData =
            XPLMFindDataRef(alt6_master_switch_data.c_str());
        alt6_master_switch_data_on_value =
            getOptionToInt("alt6_master_switch_data_on_value");
        alt6_master_switch_data_off_value =
            getOptionToInt("alt6_master_switch_data_off_value");

        alt7_master_switch_data =
            getOptionToString("alt7_master_switch_data");
        Alt7MasterSwitchData =
            XPLMFindDataRef(alt7_master_switch_data.c_str());
        alt7_master_switch_data_on_value =
            getOptionToInt("alt7_master_switch_data_on_value");
        alt7_master_switch_data_off_value =
            getOptionToInt("alt7_master_switch_data_off_value");

        alt8_master_switch_data =
            getOptionToString("alt8_master_switch_data");
        Alt8MasterSwitchData =
            XPLMFindDataRef(alt8_master_switch_data.c_str());
        alt8_master_switch_data_on_value =
            getOptionToInt("alt8_master_switch_data_on_value");
        alt8_master_switch_data_off_value =
            getOptionToInt("alt8_master_switch_data_off_value");
    }
    ...
    if ((avionicsmasterswitchenable == 3)
        ...
        av_master_switch_data_on_value =
            getOptionToInt("av_master_switch_data_on_value");
        av_master_switch_data_off_value =
            getOptionToInt("av_master_switch_data_off_value");
        ...
        av2_master_switch_dataf =
            getOptionToString("av2_master_switch_dataf");
        Av2MasterSwitchDataf =
            XPLMFindDataRef(av2_master_switch_dataf.c_str());
        av2_master_switch_data_on_value =
            getOptionToInt("av2_master_switch_data_on_value");
        av2_master_switch_data_off_value =
            getOptionToInt("av2_master_switch_data_off_value");
        ...
        av3_master_switch_dataf =
            getOptionToString("av3_master_switch_dataf");
        Av3MasterSwitchDataf =
            XPLMFindDataRef(av3_master_switch_dataf.c_str());
        av3_master_switch_data_on_value =
            getOptionToInt("av3_master_switch_data_on_value");
        av3_master_switch_data_off_value =
            getOptionToInt("av3_master_switch_data_off_value");
        ...
        av4_master_switch_dataf =
            getOptionToString("av4_master_switch_dataf");
        Av4MasterSwitchDataf =
            XPLMFindDataRef(av4_master_switch_dataf.c_str());
        av4_master_switch_data_on_value =
            getOptionToInt("av4_master_switch_data_on_value");
        av4_master_switch_data_off_value =
            getOptionToInt("av4_master_switch_data_off_value");
        ...
        av5_master_switch_dataf =
            getOptionToString("av5_master_switch_dataf");
        Av5MasterSwitchDataf =
            XPLMFindDataRef(av5_master_switch_dataf.c_str());
        av5_master_switch_data_on_value =
            getOptionToInt("av5_master_switch_data_on_value");
        av5_master_switch_data_off_value =
            getOptionToInt("av5_master_switch_data_off_value");
        ...
        av6_master_switch_dataf =
            getOptionToString("av6_master_switch_dataf");
        Av6MasterSwitchDataf =
            XPLMFindDataRef(av6_master_switch_dataf.c_str());
        av6_master_switch_data_on_value =
            getOptionToInt("av6_master_switch_data_on_value");
        av6_master_switch_data_off_value =
            getOptionToInt("av6_master_switch_data_off_value");
        ...
        av7_master_switch_dataf =
            getOptionToString("av7_master_switch_dataf");
        Av7MasterSwitchDataf =
            XPLMFindDataRef(av7_master_switch_dataf.c_str());
        av7_master_switch_data_on_value =
            getOptionToInt("av7_master_switch_data_on_value");
        av7_master_switch_data_off_value =
            getOptionToInt("av7_master_switch_data_off_value");
        ...
        av8_master_switch_dataf =
            getOptionToString("av8_master_switch_dataf");
        Av8MasterSwitchDataf =
            XPLMFindDataRef(av8_master_switch_dataf.c_str());
        av8_master_switch_data_on_value =
            getOptionToInt("av8_master_switch_data_on_value");
        ...
        av9_master_switch_dataf =
            getOptionToString("av9_master_switch_dataf");
        Av9MasterSwitchDataf =
            XPLMFindDataRef(av9_master_switch_dataf.c_str());
        av9_master_switch_data_on_value =
            getOptionToInt("av9_master_switch_data_on_value");
        av9_master_switch_data_off_value =
            getOptionToInt("av9_master_switch_data_off_value");

        av10_master_switch_data =
            getOptionToString("av10_master_switch_data");
        Av10MasterSwitchData =
            XPLMFindDataRef(av10_master_switch_data.c_str());
        av10_master_switch_dataf =
            getOptionToString("av10_master_switch_dataf");
        Av10MasterSwitchDataf =
            XPLMFindDataRef(av10_master_switch_dataf.c_str());
        av10_master_switch_data_on_value =
            getOptionToInt("av10_master_switch_data_on_value");
        av10_master_switch_data_off_value =
            getOptionToInt("av10_master_switch_data_off_value");
        av11_master_switch_data =
            getOptionToString("av11_master_switch_data");
        Av11MasterSwitchData =
            XPLMFindDataRef(av11_master_switch_data.c_str());
        av11_master_switch_dataf =
            getOptionToString("av11_master_switch_dataf");
        Av11MasterSwitchDataf =
            XPLMFindDataRef(av11_master_switch_dataf.c_str());
        av11_master_switch_data_on_value =
            getOptionToInt("av11_master_switch_data_on_value");
        av11_master_switch_data_off_value =
            getOptionToInt("av11_master_switch_data_off_value");

        av12_master_switch_data =
            getOptionToString("av12_master_switch_data");
        Av12MasterSwitchData =
            XPLMFindDataRef(av12_master_switch_data.c_str());
        av12_master_switch_dataf =
            getOptionToString("av12_master_switch_dataf");
        Av12MasterSwitchDataf =
            XPLMFindDataRef(av12_master_switch_dataf.c_str());
        av12_master_switch_data_on_value =
            getOptionToInt("av12_master_switch_data_on_value");
        av12_master_switch_data_off_value =
            getOptionToInt("av12_master_switch_data_off_value");

        av13_master_switch_data =
            getOptionToString("av13_master_switch_data");
        Av13MasterSwitchData =
            XPLMFindDataRef(av13_master_switch_data.c_str());
        av13_master_switch_dataf =
            getOptionToString("av13_master_switch_dataf");
        Av13MasterSwitchDataf =
            XPLMFindDataRef(av13_master_switch_dataf.c_str());
        av13_master_switch_data_on_value =
            getOptionToInt("av13_master_switch_data_on_value");
        av13_master_switch_data_off_value =
            getOptionToInt("av13_master_switch_data_off_value");

        av14_master_switch_data =
            getOptionToString("av14_master_switch_data");
        Av14MasterSwitchData =
            XPLMFindDataRef(av14_master_switch_data.c_str());
        av14_master_switch_dataf =
            getOptionToString("av14_master_switch_dataf");
        Av14MasterSwitchDataf =
            XPLMFindDataRef(av14_master_switch_dataf.c_str());
        av14_master_switch_data_on_value =
            getOptionToInt("av14_master_switch_data_on_value");
        av14_master_switch_data_off_value =
            getOptionToInt("av14_master_switch_data_off_value");

        av15_master_switch_data =
            getOptionToString("av15_master_switch_data");
        Av15MasterSwitchData =
            XPLMFindDataRef(av15_master_switch_data.c_str());
        av15_master_switch_dataf =
            getOptionToString("av15_master_switch_dataf");
        Av15MasterSwitchDataf =
            XPLMFindDataRef(av15_master_switch_dataf.c_str());
        av15_master_switch_data_on_value =
            getOptionToInt("av15_master_switch_data_on_value");
        av15_master_switch_data_off_value =
            getOptionToInt("av15_master_switch_data_off_value");

        av16_master_switch_data =
            getOptionToString("av16_master_switch_data");
        Av16MasterSwitchData =
            XPLMFindDataRef(av16_master_switch_data.c_str());
        av16_master_switch_dataf =
            getOptionToString("av16_master_switch_dataf");
        Av16MasterSwitchDataf =
            XPLMFindDataRef(av16_master_switch_dataf.c_str());
    ...
    if (fuelpumpswitchenable == 2) {
        ...
        fuel_pump2_switch_off =
            getOptionToString("fuel_pump2_switch_off_cmd");
        ...
        fuel_pump3_switch_off =
            getOptionToString("fuel_pump3_switch_off_cmd");
    ...
    if ((fuelpumpswitchenable == 3) || (fuelpumpswitchenable == 4)) {
        ...
        fuel_pump_switch_data_on_value =
            getOptionToInt("fuel_pump_switch_data_on_value");
        fuel_pump_switch_data_off_value =
            getOptionToInt("fuel_pump_switch_data_off_value");
        ...
        fuel_pump2_switch_data_on_value =
            getOptionToInt("fuel_pump2_switch_data_on_value");
        fuel_pump2_switch_data_off_value =
            getOptionToInt("fuel_pump2_switch_data_off_value");
        ...
        fuel_pump3_switch_data_on_value =
            getOptionToInt("fuel_pump3_switch_data_on_value");
        fuel_pump3_switch_data_off_value =
            getOptionToInt("fuel_pump3_switch_data_off_value");
        ...
        fuel_pump4_switch_data_on_value =
            getOptionToInt("fuel_pump4_switch_data_on_value");
        fuel_pump4_switch_data_off_value =
            getOptionToInt("fuel_pump4_switch_data_off_value");
        ...
        fuel_pump5_switch_data_on_value =
            getOptionToInt("fuel_pump5_switch_data_on_value");
        fuel_pump5_switch_data_off_value =
            getOptionToInt("fuel_pump5_switch_data_off_value");
        ...
        fuel_pump6_switch_data_on_value =
            getOptionToInt("fuel_pump6_switch_data_on_value");
        fuel_pump6_switch_data_off_value =
            getOptionToInt("fuel_pump6_switch_data_off_value");
        ...
        fuel_pump7_switch_data_on_value =
            getOptionToInt("fuel_pump7_switch_data_on_value");
        fuel_pump7_switch_data_off_value =
            getOptionToInt("fuel_pump7_switch_data_off_value");
    ...
    if (pitotheatswitchenable == 2) {
        ...
        pitot2_heat_switch_on =
            getOptionToString("pitot2_heat_switch_on_cmd");
        pitot2_heat_switch_off =
            getOptionToString("pitot2_heat_switch_off_cmd");
    ...
    if ((pitotheatswitchenable == 3) || (pitotheatswitchenable == 4)) {
        ...
        pitot_heat_switch_data_on_value =
            getOptionToInt("pitot_heat_switch_data_on_value");
        pitot_heat_switch_data_off_value =
            getOptionToInt("pitot_heat_switch_data_off_value");

        pitot2_heat_switch_data =
            getOptionToString("pitot2_heat_switch_data");
        Pitot2HeatSwitchData =
            XPLMFindDataRef(pitot2_heat_switch_data.c_str());
        pitot2_heat_switch_data_on_value =
            getOptionToInt("pitot2_heat_switch_data_on_value");
        pitot2_heat_switch_data_off_value =
            getOptionToInt("pitot2_heat_switch_data_off_value");

        pitot3_heat_switch_data =
            getOptionToString("pitot3_heat_switch_data");
        Pitot3HeatSwitchData =
            XPLMFindDataRef(pitot3_heat_switch_data.c_str());
        pitot3_heat_switch_data_on_value =
            getOptionToInt("pitot3_heat_switch_data_on_value");
        pitot3_heat_switch_data_off_value =
            getOptionToInt("pitot3_heat_switch_data_off_value");

        pitot4_heat_switch_data =
            getOptionToString("pitot4_heat_switch_data");
        Pitot4HeatSwitchData =
            XPLMFindDataRef(pitot4_heat_switch_data.c_str());
        pitot4_heat_switch_data_on_value =
            getOptionToInt("pitot4_heat_switch_data_on_value");
        pitot4_heat_switch_data_off_value =
            getOptionToInt("pitot4_heat_switch_data_off_value");

        pitot5_heat_switch_data =
            getOptionToString("pitot5_heat_switch_data");
        Pitot5HeatSwitchData =
            XPLMFindDataRef(pitot5_heat_switch_data.c_str());
        pitot5_heat_switch_data_on_value =
            getOptionToInt("pitot5_heat_switch_data_on_value");
        pitot5_heat_switch_data_off_value =
            getOptionToInt("pitot5_heat_switch_data_off_value");

        pitot6_heat_switch_data =
            getOptionToString("pitot6_heat_switch_data");
        Pitot6HeatSwitchData =
            XPLMFindDataRef(pitot6_heat_switch_data.c_str());
        pitot6_heat_switch_data_on_value =
            getOptionToInt("pitot6_heat_switch_data_on_value");
        pitot6_heat_switch_data_off_value =
            getOptionToInt("pitot6_heat_switch_data_off_value");

        pitot7_heat_switch_data =
            getOptionToString("pitot7_heat_switch_data");
        Pitot7HeatSwitchData =
            XPLMFindDataRef(pitot7_heat_switch_data.c_str());
        pitot7_heat_switch_data_on_value =
            getOptionToInt("pitot7_heat_switch_data_on_value");
        pitot7_heat_switch_data_off_value =
            getOptionToInt("pitot7_heat_switch_data_off_value");

        pitot8_heat_switch_data =
            getOptionToString("pitot8_heat_switch_data");
        Pitot8HeatSwitchData =
            XPLMFindDataRef(pitot8_heat_switch_data.c_str());
        pitot8_heat_switch_data_on_value =
            getOptionToInt("pitot8_heat_switch_data_on_value");
        pitot8_heat_switch_data_off_value =
            getOptionToInt("pitot8_heat_switch_data_off_value");
    ...
    if ((landinggearknobupenable == 3) || (landinggearknobupenable == 4)) {
        ...
        gear_switch_up_data_on_value =
            getOptionToInt("gear_up_switch_data_on_value");
        gear_switch_up_data_off_value =
            getOptionToInt("gear_up_switch_data_off_value");
    ...
    if ((landinggearknobdnenable == 3) || (landinggearknobdnenable == 4)) {
        ...
        gear_switch_down_data_on_value =
            getOptionToInt("gear_dn_switch_data_on_value");
    ...
    if (panellightswitchenable == 2) {
        ...
        panel_lights_switch_off =
            getOptionToString("panel_lights_switch_off_cmd");
    ...
    if ((panellightswitchenable == 3) || (panellightswitchenable == 4)
        ...
        panel_lights_switch_data =
            getOptionToString("panel_lights_switch_data");
        PanelLightsData = XPLMFindDataRef(panel_lights_switch_data.c_str());
        panel_lights_switch_data_on_value =
            getOptionToInt("panel_lights_switch_data_on_value");
        panel_lights_switch_data_off_value =
            getOptionToInt("panel_lights_switch_data_off_value");
        panel_lights_switch_data_array_offset =
            getOptionToInt("panel_lights_switch_data_array_offset");
        panel_lights_switch_data_array_size =
            getOptionToInt("panel_lights_switch_data_array_size");

        panel_lights_switch2_data =
            getOptionToString("panel_lights_switch2_data");
        PanelLights2Data = XPLMFindDataRef(panel_lights_switch2_data.c_str());
        panel_lights_switch2_data_on_value =
            getOptionToInt("panel_lights_switch2_data_on_value");
        panel_lights_switch2_data_off_value =
            getOptionToInt("panel_lights_switch2_data_off_value");
        panel_lights_switch2_data_array_offset =
            getOptionToInt("panel_lights_switch2_data_array_offset");
        panel_lights_switch2_data_array_size =
            getOptionToInt("panel_lights_switch2_data_array_size");

        panel_lights_switch3_data =
            getOptionToString("panel_lights_switch3_data");
        PanelLights3Data = XPLMFindDataRef(panel_lights_switch3_data.c_str());
        panel_lights_switch3_data_on_value =
            getOptionToInt("panel_lights_switch3_data_on_value");
        panel_lights_switch3_data_off_value =
            getOptionToInt("panel_lights_switch3_data_off_value");
        panel_lights_switch3_data_array_offset =
            getOptionToInt("panel_lights_switch3_data_array_offset");
        panel_lights_switch3_data_array_size =
            getOptionToInt("panel_lights_switch3_data_array_size");

        panel_lights_switch4_data =
            getOptionToString("panel_lights_switch4_data");
        PanelLights4Data = XPLMFindDataRef(panel_lights_switch4_data.c_str());
        panel_lights_switch4_data_on_value =
            getOptionToInt("panel_lights_switch4_data_on_value");
        panel_lights_switch4_data_off_value =
            getOptionToInt("panel_lights_switch4_data_off_value");
        panel_lights_switch4_data_array_offset =
            getOptionToInt("panel_lights_switch4_data_array_offset");
        panel_lights_switch4_data_array_size =
            getOptionToInt("panel_lights_switch4_data_array_size");

        panel_lights_switch5_data =
            getOptionToString("panel_lights_switch5_data");
        PanelLights5Data = XPLMFindDataRef(panel_lights_switch5_data.c_str());
        panel_lights_switch5_data_on_value =
            getOptionToInt("panel_lights_switch5_data_on_value");
        panel_lights_switch5_data_off_value =
            getOptionToInt("panel_lights_switch5_data_off_value");
        panel_lights_switch5_data_array_offset =
            getOptionToInt("panel_lights_switch5_data_array_offset");
        panel_lights_switch5_data_array_size =
            getOptionToInt("panel_lights_switch5_data_array_size");

        panel_lights_switch6_data =
            getOptionToString("panel_lights_switch6_data");
        PanelLights6Data = XPLMFindDataRef(panel_lights_switch6_data.c_str());
        panel_lights_switch6_data_on_value =
            getOptionToInt("panel_lights_switch6_data_on_value");
        panel_lights_switch6_data_off_value =
            getOptionToInt("panel_lights_switch6_data_off_value");
        panel_lights_switch6_data_array_offset =
            getOptionToInt("panel_lights_switch6_data_array_offset");
        panel_lights_switch6_data_array_size =
            getOptionToInt("panel_lights_switch6_data_array_size");

        panel_lights_switch7_data =
            getOptionToString("panel_lights_switch7_data");
        PanelLights7Data = XPLMFindDataRef(panel_lights_switch7_data.c_str());
        panel_lights_switch7_data_on_value =
            getOptionToInt("panel_lights_switch7_data_on_value");
        panel_lights_switch7_data_off_value =
            getOptionToInt("panel_lights_switch7_data_off_value");
        panel_lights_switch7_data_array_offset =
            getOptionToInt("panel_lights_switch7_data_array_offset");
        panel_lights_switch7_data_array_size =
            getOptionToInt("panel_lights_switch7_data_array_size");

        panel_lights_switch8_data =
            getOptionToString("panel_lights_switch8_data");
        PanelLights8Data = XPLMFindDataRef(panel_lights_switch8_data.c_str());
        panel_lights_switch8_data_on_value =
            getOptionToInt("panel_lights_switch8_data_on_value");
        panel_lights_switch8_data_off_value =
            getOptionToInt("panel_lights_switch8_data_off_value");
    ...
    if (beaconlightswitchenable == 2) {
        ...
        beacon_lights_switch_off =
            getOptionToString("beacon_lights_switch_off_cmd");
        BeaconLightsOnCmd = XPLMFindCommand(beacon_lights_switch_on.c_str());
        BeaconLightsOffCmd =
            XPLMFindCommand(beacon_lights_switch_off.c_str());
    }

    if ((beaconlightswitchenable == 3) || (beaconlightswitchenable == 4)) {
        beacon_lights_switch_data =
            getOptionToString("beacon_lights_switch_data");
        BeaconLightsData = XPLMFindDataRef(beacon_lights_switch_data.c_str());
        beacon_lights_switch_data_on_value =
            getOptionToInt("beacon_lights_switch_data_on_value");
        beacon_lights_switch_data_off_value =
            getOptionToInt("beacon_lights_switch_data_off_value");

        beacon_lights_switch2_data =
            getOptionToString("beacon_lights_switch2_data");
        BeaconLights2Data =
            XPLMFindDataRef(beacon_lights_switch2_data.c_str());
        beacon_lights_switch2_data_on_value =
            getOptionToInt("beacon_lights_switch2_data_on_value");
        beacon_lights_switch2_data_off_value =
            getOptionToInt("beacon_lights_switch2_data_off_value");

        beacon_lights_switch3_data =
            getOptionToString("beacon_lights_switch3_data");
        BeaconLights3Data =
            XPLMFindDataRef(beacon_lights_switch3_data.c_str());
        beacon_lights_switch3_data_on_value =
            getOptionToInt("beacon_lights_switch3_data_on_value");
        beacon_lights_switch3_data_off_value =
            getOptionToInt("beacon_lights_switch3_data_off_value");

        beacon_lights_switch4_data =
            getOptionToString("beacon_lights_switch4_data");
        BeaconLights4Data =
            XPLMFindDataRef(beacon_lights_switch4_data.c_str());
    ...
    if ((navlightswitchenable == 3) || (navlightswitchenable == 4)) {
        ...
        nav_lights_switch_data_on_value =
            getOptionToInt("nav_lights_switch_data_on_value");
        nav_lights_switch_data_off_value =
            getOptionToInt("nav_lights_switch_data_off_value");

        nav_lights_switch2_data =
            getOptionToString("nav_lights_switch2_data");
        NavLights2Data = XPLMFindDataRef(nav_lights_switch2_data.c_str());
        nav_lights_switch2_data_on_value =
            getOptionToInt("nav_lights_switch2_data_on_value");
        nav_lights_switch2_data_off_value =
            getOptionToInt("nav_lights_switch2_data_off_value");

        nav_lights_switch3_data =
            getOptionToString("nav_lights_switch3_data");
        NavLights3Data = XPLMFindDataRef(nav_lights_switch3_data.c_str());
        nav_lights_switch3_data_on_value =
            getOptionToInt("nav_lights_switch3_data_on_value");
        nav_lights_switch3_data_off_value =
            getOptionToInt("nav_lights_switch3_data_off_value");

        nav_lights_switch4_data =
            getOptionToString("nav_lights_switch4_data");
    ...
    if (strobelightswitchenable == 2) {
        ...
        strobe_lights_switch_off =
            getOptionToString("strobe_lights_switch_off_cmd");
        StrobeLightsOnCmd = XPLMFindCommand(strobe_lights_switch_on.c_str());
        StrobeLightsOffCmd =
            XPLMFindCommand(strobe_lights_switch_off.c_str());
    }

    if ((strobelightswitchenable == 3) || (strobelightswitchenable == 4)) {
        strobe_lights_switch_data =
            getOptionToString("strobe_lights_switch_data");
        StrobeLightsData = XPLMFindDataRef(strobe_lights_switch_data.c_str());
        strobe_lights_switch_data_on_value =
            getOptionToInt("strobe_lights_switch_data_on_value");
        strobe_lights_switch_data_off_value =
            getOptionToInt("strobe_lights_switch_data_off_value");

        strobe_lights_switch2_data =
            getOptionToString("strobe_lights_switch2_data");
        StrobeLights2Data =
            XPLMFindDataRef(strobe_lights_switch2_data.c_str());
        strobe_lights_switch2_data_on_value =
            getOptionToInt("strobe_lights_switch2_data_on_value");
        strobe_lights_switch2_data_off_value =
            getOptionToInt("strobe_lights_switch2_data_off_value");

        strobe_lights_switch3_data =
            getOptionToString("strobe_lights_switch3_data");
        StrobeLights3Data =
            XPLMFindDataRef(strobe_lights_switch3_data.c_str());
        strobe_lights_switch3_data_on_value =
            getOptionToInt("strobe_lights_switch3_data_on_value");
        strobe_lights_switch3_data_off_value =
            getOptionToInt("strobe_lights_switch3_data_off_value");

        strobe_lights_switch4_data =
            getOptionToString("strobe_lights_switch4_data");
        StrobeLights4Data =
            XPLMFindDataRef(strobe_lights_switch4_data.c_str());
    ...
    if (taxilightswitchenable == 2) {
        ...
        taxi_lights_switch_off =
            getOptionToString("taxi_lights_switch_off_cmd");
    ...
    if ((taxilightswitchenable == 3) || (taxilightswitchenable == 4)) {
        taxi_lights_switch_data =
            getOptionToString("taxi_lights_switch_data");
        TaxiLightsData = XPLMFindDataRef(taxi_lights_switch_data.c_str());
        taxi_lights_switch_data_on_value =
            getOptionToInt("taxi_lights_switch_data_on_value");
        taxi_lights_switch_data_off_value =
            getOptionToInt("taxi_lights_switch_data_off_value");

        taxi_lights_switch2_data =
            getOptionToString("taxi_lights_switch2_data");
        TaxiLights2Data = XPLMFindDataRef(taxi_lights_switch2_data.c_str());
        taxi_lights_switch2_data_on_value =
            getOptionToInt("taxi_lights_switch2_data_on_value");
        taxi_lights_switch2_data_off_value =
            getOptionToInt("taxi_lights_switch2_data_off_value");

        taxi_lights_switch3_data =
            getOptionToString("taxi_lights_switch3_data");
        TaxiLights3Data = XPLMFindDataRef(taxi_lights_switch3_data.c_str());
        taxi_lights_switch3_data_on_value =
            getOptionToInt("taxi_lights_switch3_data_on_value");
        taxi_lights_switch3_data_off_value =
            getOptionToInt("taxi_lights_switch3_data_off_value");

        taxi_lights_switch4_data =
            getOptionToString("taxi_lights_switch4_data");
    ...
    if (landinglightswitchenable == 1) {
        XPSetWidgetProperty(SwitchEnableCheckWidget[19],
            xpProperty_ButtonState, 1);
    ...
    if (landinglightswitchenable == 2) {
        ...
        landing_lights_switch_off =
            getOptionToString("landing_lights_switch_off_cmd");
        LandingLightsOnCmd =
            XPLMFindCommand(landing_lights_switch_on.c_str());
        LandingLightsOffCmd =
            XPLMFindCommand(landing_lights_switch_off.c_str());
    }

    if ((landinglightswitchenable == 3) || (landinglightswitchenable == 4)) {
        landing_lights_switch_data =
            getOptionToString("landing_lights_switch_data");
        LandingLightsData =
            XPLMFindDataRef(landing_lights_switch_data.c_str());
        landing_lights_switch_data_on_value =
            getOptionToInt("landing_lights_switch_data_on_value");
        landing_lights_switch_data_off_value =
            getOptionToInt("landing_lights_switch_data_off_value");

        landing_lights_switch2_data =
            getOptionToString("landing_lights_switch2_data");
        LandingLights2Data =
            XPLMFindDataRef(landing_lights_switch2_data.c_str());
        landing_lights_switch2_data_on_value =
            getOptionToInt("landing_lights_switch2_data_on_value");
        landing_lights_switch2_data_off_value =
            getOptionToInt("landing_lights_switch2_data_off_value");

        landing_lights_switch3_data =
            getOptionToString("landing_lights_switch3_data");
        LandingLights3Data =
            XPLMFindDataRef(landing_lights_switch3_data.c_str());
        landing_lights_switch3_data_on_value =
            getOptionToInt("landing_lights_switch3_data_on_value");
        landing_lights_switch3_data_off_value =
            getOptionToInt("landing_lights_switch3_data_off_value");

        landing_lights_switch4_data =
            getOptionToString("landing_lights_switch4_data");
        LandingLights4Data =
            XPLMFindDataRef(landing_lights_switch4_data.c_str());
...
// *******************  Radio Panel Commands   **********************************
    ...
    if (radspeed == 2) {
        XPSetWidgetProperty(RadioSpeed2CheckWidget[0], xpProperty_ButtonState,
            1);
    }
    if (radspeed == 3) {
        XPSetWidgetProperty(RadioSpeed3CheckWidget[0], xpProperty_ButtonState,
            1);
    }
    if (radspeed == 4) {
        XPSetWidgetProperty(RadioSpeed4CheckWidget[0], xpProperty_ButtonState,
            1);
    }
    if (radspeed == 5) {
    ...
    rad1uprcom1switchremap =
        getOptionToInt("Radio1 Upper Com1 Switch remapable");
    if (rad1uprcom1switchremap == 1) {
        rad1_upper_com1_corse_up_remapable =
            getOptionToString("rad1_upper_com1_corse_up_cmd");
        Rad1UprCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_com1_corse_up_remapable.c_str());

        rad1_upper_com1_corse_dn_remapable =
            getOptionToString("rad1_upper_com1_corse_dn_cmd");
        Rad1UprCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_com1_corse_dn_remapable.c_str());

        rad1_upper_com1_fine_up_remapable =
            getOptionToString("rad1_upper_com1_fine_up_cmd");
        Rad1UprCom1FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_com1_fine_up_remapable.c_str());

        rad1_upper_com1_fine_dn_remapable =
            getOptionToString("rad1_upper_com1_fine_dn_cmd");
        Rad1UprCom1FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_com1_fine_dn_remapable.c_str());

        rad1_upper_com1_act_data_remapable =
            getOptionToString("rad1_upper_com1_act_data");
        Rad1UpperCom1ActRemapableData =
            XPLMFindDataRef(rad1_upper_com1_act_data_remapable.c_str());
    ...
    rad1uprcom1actstbybtnremap =
        getOptionToInt("Radio1 Upper Com1 ActStby remapable");
    ...
    rad1uprcom2switchremap =
        getOptionToInt("Radio1 Upper Com2 Switch remapable");
    if (rad1uprcom2switchremap == 1) {
        rad1_upper_com2_corse_up_remapable =
            getOptionToString("rad1_upper_com2_corse_up_cmd");
        Rad1UprCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_com2_corse_up_remapable.c_str());

        rad1_upper_com2_corse_dn_remapable =
            getOptionToString("rad1_upper_com2_corse_dn_cmd");
        Rad1UprCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_com2_corse_dn_remapable.c_str());

        rad1_upper_com2_fine_up_remapable =
            getOptionToString("rad1_upper_com2_fine_up_cmd");
        Rad1UprCom2FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_com2_fine_up_remapable.c_str());

        rad1_upper_com2_fine_dn_remapable =
            getOptionToString("rad1_upper_com2_fine_dn_cmd");
        Rad1UprCom2FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_com2_fine_dn_remapable.c_str());

        rad1_upper_com2_act_data_remapable =
            getOptionToString("rad1_upper_com2_act_data");
        Rad1UpperCom2ActRemapableData =
            XPLMFindDataRef(rad1_upper_com2_act_data_remapable.c_str());
    ...
    rad1uprcom2actstbybtnremap =
        getOptionToInt("Radio1 Upper Com2 ActStby remapable");
    ...
    if (rad1uprcom2actstbybtnremap == 2) {
        ...
        rad1_upr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad1_upr_com2_actstby_btn_data_off_value");
    }


    // Radio1 Upper Nav1 switch - remapable
    rad1uprnav1switchremap =
        getOptionToInt("Radio1 Upper Nav1 Switch remapable");
    if (rad1uprnav1switchremap == 1) {
        rad1_upper_obs1_corse_up_remapable =
            getOptionToString("rad1_upper_obs1_corse_up_cmd");
        Rad1UprObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_obs1_corse_up_remapable.c_str());

        rad1_upper_obs1_corse_dn_remapable =
            getOptionToString("rad1_upper_obs1_corse_dn_cmd");
        Rad1UprObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_obs1_corse_dn_remapable.c_str());

        rad1_upper_obs1_fine_up_remapable =
            getOptionToString("rad1_upper_obs1_fine_up_cmd");
        Rad1UprObs1FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_obs1_fine_up_remapable.c_str());

        rad1_upper_obs1_fine_dn_remapable =
            getOptionToString("rad1_upper_obs1_fine_dn_cmd");
        Rad1UprObs1FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_obs1_fine_dn_remapable.c_str());

        rad1_upper_obs1_remapable_dataf =
            getOptionToString("rad1_upper_obs1_dataf");
        ...
        Rad1UprNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_nav1_corse_up_remapable.c_str());

        rad1_upper_nav1_corse_dn_remapable =
            getOptionToString("rad1_upper_nav1_corse_dn_cmd");
        Rad1UprNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_nav1_corse_dn_remapable.c_str());

        rad1_upper_nav1_fine_up_remapable =
            getOptionToString("rad1_upper_nav1_fine_up_cmd");
        Rad1UprNav1FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_nav1_fine_up_remapable.c_str());

        rad1_upper_nav1_fine_dn_remapable =
            getOptionToString("rad1_upper_nav1_fine_dn_cmd");
        Rad1UprNav1FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_nav1_fine_dn_remapable.c_str());

        rad1_upper_nav1_act_data_remapable =
            getOptionToString("rad1_upper_nav1_act_data");
        Rad1UpperNav1ActRemapableData =
            XPLMFindDataRef(rad1_upper_nav1_act_data_remapable.c_str());
    ...
    rad1uprnav1actstbybtnremap =
        getOptionToInt("Radio1 Upper Nav1 ActStby remapable");
    ...
    rad1uprnav2switchremap =
        getOptionToInt("Radio1 Upper Nav2 Switch remapable");
    if (rad1uprnav2switchremap == 1) {
        rad1_upper_obs2_corse_up_remapable =
            getOptionToString("rad1_upper_obs2_corse_up_cmd");
        Rad1UprObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_obs2_corse_up_remapable.c_str());

        rad1_upper_obs2_corse_dn_remapable =
            getOptionToString("rad1_upper_obs2_corse_dn_cmd");
        Rad1UprObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_obs2_corse_dn_remapable.c_str());

        rad1_upper_obs2_fine_up_remapable =
            getOptionToString("rad1_upper_obs2_fine_up_cmd");
        Rad1UprObs2FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_obs2_fine_up_remapable.c_str());

        rad1_upper_obs2_fine_dn_remapable =
            getOptionToString("rad1_upper_obs2_fine_dn_cmd");
        Rad1UprObs2FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_obs2_fine_dn_remapable.c_str());

        rad1_upper_obs2_remapable_dataf =
            getOptionToString("rad1_upper_obs2_dataf");
        ...
        Rad1UprNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_nav2_corse_up_remapable.c_str());

        rad1_upper_nav2_corse_dn_remapable =
            getOptionToString("rad1_upper_nav2_corse_dn_cmd");
        Rad1UprNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_nav2_corse_dn_remapable.c_str());

        rad1_upper_nav2_fine_up_remapable =
            getOptionToString("rad1_upper_nav2_fine_up_cmd");
        Rad1UprNav2FnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_nav2_fine_up_remapable.c_str());

        rad1_upper_nav2_fine_dn_remapable =
            getOptionToString("rad1_upper_nav2_fine_dn_cmd");
        Rad1UprNav2FnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_nav2_fine_dn_remapable.c_str());

        rad1_upper_nav2_act_data_remapable =
            getOptionToString("rad1_upper_nav2_act_data");
        Rad1UpperNav2ActRemapableData =
            XPLMFindDataRef(rad1_upper_nav2_act_data_remapable.c_str());
    ...
    rad1uprnav2actstbybtnremap =
        getOptionToInt("Radio1 Upper Nav2 ActStby remapable");
    ...
    if (rad1uprnav2actstbybtnremap == 2) {
        ...
        rad1_upr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad1_upr_nav2_actstby_btn_data_off_value");
    }
    ...
    if (rad1upradfswitchremap == 1) {
        ...
        Rad1UprAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad1_upper_adf_corse_up_remapable.c_str());

        rad1_upper_adf_corse_dn_remapable =
            getOptionToString("rad1_upper_adf_corse_dn_cmd");
        Rad1UprAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad1_upper_adf_corse_dn_remapable.c_str());

        rad1_upper_adf_fine_up_remapable =
            getOptionToString("rad1_upper_adf_fine_up_cmd");
        Rad1UprAdfFnUpRemapableCmd =
            XPLMFindCommand(rad1_upper_adf_fine_up_remapable.c_str());

        rad1_upper_adf_fine_dn_remapable =
            getOptionToString("rad1_upper_adf_fine_dn_cmd");
        Rad1UprAdfFnDnRemapableCmd =
            XPLMFindCommand(rad1_upper_adf_fine_dn_remapable.c_str());

        rad1_upper_adf_act_data_remapable =
            getOptionToString("rad1_upper_adf_act_data");
        Rad1UpperAdfActRemapableData =
            XPLMFindDataRef(rad1_upper_adf_act_data_remapable.c_str());
    ...
    rad1upradfactstbybtnremap =
        getOptionToInt("Radio1 Upper Adf ActStby remapable");
    if (rad1upradfactstbybtnremap == 1) {
        rad1_upper_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad1_upper_adf_actstby_btn_cmd");
        Rad1UprAdfActStbyRemapableCmd =
    ...
    if (rad1upradfactstbybtnremap == 2) {
        ...
        rad1_upr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad1_upr_adf_actstby_btn_data_off_value");
    }
    ...
    rad1uprxpdrswitchremap =
        getOptionToInt("Radio1 Upper Xpdr Switch remapable");
    if (rad1uprxpdrswitchremap == 777) {
        rad1_upper_xpdr_data_remapable =
            getOptionToString("rad1_upper_xpdr_data");
        Rad1UpperXpdrRemapableData =
            XPLMFindDataRef(rad1_upper_xpdr_data_remapable.c_str());

        rad1_upper_xpdr_mode_remapable =
            getOptionToString("rad1_upper_xpdr_mode");
        Rad1UpperXpdrRemapableMode =
            XPLMFindDataRef(rad1_upper_xpdr_mode_remapable.c_str());

        rad1_upper_xpdr_baro_std_data_remapable =
            getOptionToString("rad1_upper_xpdr_baro_std_data");
        Rad1UpperXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad1_upper_xpdr_baro_std_data_remapable.c_str());

        rad1_upper_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad1_upper_xpdr_baro_up_cmd");
        Rad1UpperXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad1_upper_xpdr_baro_up_remapable_cmd.c_str());
    ...
    rad1lwrcom1switchremap =
        getOptionToInt("Radio1 Lower Com1 Switch remapable");
    if (rad1lwrcom1switchremap == 1) {
        rad1_lower_com1_corse_up_remapable =
            getOptionToString("rad1_lower_com1_corse_up_cmd");
        Rad1LowrCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_com1_corse_up_remapable.c_str());

        rad1_lower_com1_corse_dn_remapable =
            getOptionToString("rad1_lower_com1_corse_dn_cmd");
        Rad1LowrCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_com1_corse_dn_remapable.c_str());

        rad1_lower_com1_fine_up_remapable =
            getOptionToString("rad1_lower_com1_fine_up_cmd");
        Rad1LowrCom1FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_com1_fine_up_remapable.c_str());

        rad1_lower_com1_fine_dn_remapable =
            getOptionToString("rad1_lower_com1_fine_dn_cmd");
        Rad1LowrCom1FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_com1_fine_dn_remapable.c_str());

        rad1_lower_com1_act_data_remapable =
            getOptionToString("rad1_lower_com1_act_data");
        Rad1LowerCom1ActRemapableData =
            XPLMFindDataRef(rad1_lower_com1_act_data_remapable.c_str());
    ...
    rad1lwrcom1actstbybtnremap =
        getOptionToInt("Radio1 Lower Com1 ActStby remapable");
    ...
    if (rad1lwrcom1actstbybtnremap == 2) {
        ...
        rad1_lwr_com1_actstby_btn_data_off_value =
            getOptionToInt("rad1_lwr_com1_actstby_btn_data_off_value");
    }
    // Radio1 Lower Com2 switch - remapable
    rad1lwrcom2switchremap =
        getOptionToInt("Radio1 Lower Com2 Switch remapable");
    if (rad1lwrcom2switchremap == 1) {
        rad1_lower_com2_corse_up_remapable =
            getOptionToString("rad1_lower_com2_corse_up_cmd");
        Rad1LowrCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_com2_corse_up_remapable.c_str());

        rad1_lower_com2_corse_dn_remapable =
            getOptionToString("rad1_lower_com2_corse_dn_cmd");
        Rad1LowrCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_com2_corse_dn_remapable.c_str());

        rad1_lower_com2_fine_up_remapable =
            getOptionToString("rad1_lower_com2_fine_up_cmd");
        Rad1LowrCom2FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_com2_fine_up_remapable.c_str());

        rad1_lower_com2_fine_dn_remapable =
            getOptionToString("rad1_lower_com2_fine_dn_cmd");
        Rad1LowrCom2FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_com2_fine_dn_remapable.c_str());

        rad1_lower_com2_act_data_remapable =
            getOptionToString("rad1_lower_com2_act_data");
        Rad1LowerCom2ActRemapableData =
            XPLMFindDataRef(rad1_lower_com2_act_data_remapable.c_str());

        rad1_lower_com2_stby_data_remapable =
            getOptionToString("rad1_lower_com2_stby_data");
        Rad1LowerCom2StbyRemapableData =
            XPLMFindDataRef(rad1_lower_com2_stby_data_remapable.c_str());

    }
    // Radio1 Lower Com2 active stanby button - remapable
    rad1lwrcom2actstbybtnremap =
        getOptionToInt("Radio1 Lower Com2 ActStby remapable");
    ...
    if (rad1lwrcom2actstbybtnremap == 2) {
        ...
        rad1_lwr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad1_lwr_com2_actstby_btn_data_off_value");
    }
    // Radio1 Lower Nav1 switch - remapable
    rad1lwrnav1switchremap =
        getOptionToInt("Radio1 Lower Nav1 Switch remapable");
    if (rad1lwrnav1switchremap == 1) {
        rad1_lower_obs1_corse_up_remapable =
            getOptionToString("rad1_lower_obs1_corse_up_cmd");
        Rad1LowrObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_obs1_corse_up_remapable.c_str());

        rad1_lower_obs1_corse_dn_remapable =
            getOptionToString("rad1_lower_obs1_corse_dn_cmd");
        Rad1LowrObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_obs1_corse_dn_remapable.c_str());

        rad1_lower_obs1_fine_up_remapable =
            getOptionToString("rad1_lower_obs1_fine_up_cmd");
        Rad1LowrObs1FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_obs1_fine_up_remapable.c_str());

        rad1_lower_obs1_fine_dn_remapable =
            getOptionToString("rad1_lower_obs1_fine_dn_cmd");
        Rad1LowrObs1FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_obs1_fine_dn_remapable.c_str());

        rad1_lower_obs1_remapable_dataf =
            getOptionToString("rad1_lower_obs1_dataf");
        Rad1LowerObs1RemapableDataf =
            XPLMFindDataRef(rad1_lower_obs1_remapable_dataf.c_str());


        rad1_lower_nav1_corse_up_remapable =
            getOptionToString("rad1_lower_nav1_corse_up_cmd");
        Rad1LowrNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_nav1_corse_up_remapable.c_str());

        rad1_lower_nav1_corse_dn_remapable =
            getOptionToString("rad1_lower_nav1_corse_dn_cmd");
        Rad1LowrNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_nav1_corse_dn_remapable.c_str());

        rad1_lower_nav1_fine_up_remapable =
            getOptionToString("rad1_lower_nav1_fine_up_cmd");
        Rad1LowrNav1FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_nav1_fine_up_remapable.c_str());

        rad1_lower_nav1_fine_dn_remapable =
            getOptionToString("rad1_lower_nav1_fine_dn_cmd");
        Rad1LowrNav1FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_nav1_fine_dn_remapable.c_str());

        rad1_lower_nav1_act_data_remapable =
            getOptionToString("rad1_lower_nav1_act_data");
        Rad1LowerNav1ActRemapableData =
            XPLMFindDataRef(rad1_lower_nav1_act_data_remapable.c_str());

        rad1_lower_nav1_stby_data_remapable =
            getOptionToString("rad1_lower_nav1_stby_data");
        Rad1LowerNav1StbyRemapableData =
            XPLMFindDataRef(rad1_lower_nav1_stby_data_remapable.c_str());


    }
    // Radio1 Lower Nav1 active stanby button - remapable
    rad1lwrnav1actstbybtnremap =
        getOptionToInt("Radio1 Lower Nav1 ActStby remapable");
    ...
    if (rad1lwrnav1actstbybtnremap == 2) {
        ...
        rad1_lwr_nav1_actstby_btn_data_off_value =
            getOptionToInt("rad1_lwr_nav1_actstby_btn_data_off_value");
    }
    // Radio1 Lower Nav2 switch - remapable
    rad1lwrnav2switchremap =
        getOptionToInt("Radio1 Lower Nav2 Switch remapable");
    if (rad1lwrnav2switchremap == 1) {
        rad1_lower_obs2_corse_up_remapable =
            getOptionToString("rad1_lower_obs2_corse_up_cmd");
        Rad1LowrObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_obs2_corse_up_remapable.c_str());

        rad1_lower_obs2_corse_dn_remapable =
            getOptionToString("rad1_lower_obs2_corse_dn_cmd");
        Rad1LowrObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_obs2_corse_dn_remapable.c_str());

        rad1_lower_obs2_fine_up_remapable =
            getOptionToString("rad1_lower_obs2_fine_up_cmd");
        Rad1LowrObs2FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_obs2_fine_up_remapable.c_str());

        rad1_lower_obs2_fine_dn_remapable =
            getOptionToString("rad1_lower_obs2_fine_dn_cmd");
        Rad1LowrObs2FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_obs2_fine_dn_remapable.c_str());

        rad1_lower_obs2_remapable_dataf =
            getOptionToString("rad1_lower_obs2_dataf");
        Rad1LowerObs2RemapableDataf =
            XPLMFindDataRef(rad1_lower_obs2_remapable_dataf.c_str());


        rad1_lower_nav2_corse_up_remapable =
            getOptionToString("rad1_lower_nav2_corse_up_cmd");
        Rad1LowrNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_nav2_corse_up_remapable.c_str());

        rad1_lower_nav2_corse_dn_remapable =
            getOptionToString("rad1_lower_nav2_corse_dn_cmd");
        Rad1LowrNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_nav2_corse_dn_remapable.c_str());

        rad1_lower_nav2_fine_up_remapable =
            getOptionToString("rad1_lower_nav2_fine_up_cmd");
        Rad1LowrNav2FnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_nav2_fine_up_remapable.c_str());

        rad1_lower_nav2_fine_dn_remapable =
            getOptionToString("rad1_lower_nav2_fine_dn_cmd");
        Rad1LowrNav2FnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_nav2_fine_dn_remapable.c_str());

        rad1_lower_nav2_act_data_remapable =
            getOptionToString("rad1_lower_nav2_act_data");
        Rad1LowerNav2ActRemapableData =
            XPLMFindDataRef(rad1_lower_nav2_act_data_remapable.c_str());
    ...
    rad1lwrnav2actstbybtnremap =
        getOptionToInt("Radio1 Lower Nav2 ActStby remapable");
    ...
    if (rad1lwrnav2actstbybtnremap == 2) {
        ...
        rad1_lwr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad1_lwr_nav2_actstby_btn_data_off_value");
    }
    ...
    if (rad1lwradfswitchremap == 1) {
        ...
        Rad1LowrAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad1_lower_adf_corse_up_remapable.c_str());

        rad1_lower_adf_corse_dn_remapable =
            getOptionToString("rad1_lower_adf_corse_dn_cmd");
        Rad1LowrAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad1_lower_adf_corse_dn_remapable.c_str());

        rad1_lower_adf_fine_up_remapable =
            getOptionToString("rad1_lower_adf_fine_up_cmd");
        Rad1LowrAdfFnUpRemapableCmd =
            XPLMFindCommand(rad1_lower_adf_fine_up_remapable.c_str());

        rad1_lower_adf_fine_dn_remapable =
            getOptionToString("rad1_lower_adf_fine_dn_cmd");
        Rad1LowrAdfFnDnRemapableCmd =
            XPLMFindCommand(rad1_lower_adf_fine_dn_remapable.c_str());

        rad1_lower_adf_act_data_remapable =
            getOptionToString("rad1_lower_adf_act_data");
        Rad1LowerAdfActRemapableData =
            XPLMFindDataRef(rad1_lower_adf_act_data_remapable.c_str());
    ...
    rad1lwradfactstbybtnremap =
        getOptionToInt("Radio1 Lower Adf ActStby remapable");
    if (rad1lwradfactstbybtnremap == 1) {
        rad1_lower_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad1_lower_adf_actstby_btn_cmd");
        Rad1LowrAdfActStbyRemapableCmd =
    ...
    if (rad1upradfactstbybtnremap == 2) {
        ...
        rad1_lwr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad1_lwr_adf_actstby_btn_data_off_value");
    }
    ...
    if (rad1lwrxpdrswitchremap == 777) {
        rad1_lower_xpdr_data_remapable =
            getOptionToString("rad1_lower_xpdr_data");
        Rad1LowerXpdrRemapableData =
            XPLMFindDataRef(rad1_lower_xpdr_data_remapable.c_str());

        rad1_lower_xpdr_mode_remapable =
            getOptionToString("rad1_lower_xpdr_mode");
        Rad1LowerXpdrRemapableMode =
            XPLMFindDataRef(rad1_lower_xpdr_mode_remapable.c_str());

        rad1_lower_xpdr_baro_std_data_remapable =
            getOptionToString("rad1_lower_xpdr_baro_std_data");
        Rad1LowerXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad1_lower_xpdr_baro_std_data_remapable.c_str());

        rad1_lower_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad1_lower_xpdr_baro_up_cmd");
        Rad1LowrXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad1_lower_xpdr_baro_up_remapable_cmd.c_str());
    ...
    rad2uprcom1switchremap =
        getOptionToInt("Radio2 Upper Com1 Switch remapable");
    if (rad2uprcom1switchremap == 1) {
        rad2_upper_com1_corse_up_remapable =
            getOptionToString("rad2_upper_com1_corse_up_cmd");
        Rad2UprCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_com1_corse_up_remapable.c_str());

        rad2_upper_com1_corse_dn_remapable =
            getOptionToString("rad2_upper_com1_corse_dn_cmd");
        Rad2UprCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_com1_corse_dn_remapable.c_str());

        rad2_upper_com1_fine_up_remapable =
            getOptionToString("rad2_upper_com1_fine_up_cmd");
        Rad2UprCom1FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_com1_fine_up_remapable.c_str());

        rad2_upper_com1_fine_dn_remapable =
            getOptionToString("rad2_upper_com1_fine_dn_cmd");
        Rad2UprCom1FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_com1_fine_dn_remapable.c_str());

        rad2_upper_com1_act_data_remapable =
            getOptionToString("rad2_upper_com1_act_data");
        Rad2UpperCom1ActRemapableData =
            XPLMFindDataRef(rad2_upper_com1_act_data_remapable.c_str());
    ...
    rad2uprcom1actstbybtnremap =
        getOptionToInt("Radio2 Upper Com1 ActStby remapable");
    ...
    if (rad2uprcom1actstbybtnremap == 2) {
        ...
        rad2_upr_com1_actstby_btn_data_off_value =
            getOptionToInt("rad2_upr_com1_actstby_btn_data_off_value");
    }
    // Radio2 Upper Com2 switch - remapable
    rad2uprcom2switchremap =
        getOptionToInt("Radio2 Upper Com2 Switch remapable");
    if (rad2uprcom2switchremap == 1) {
        rad2_upper_com2_corse_up_remapable =
            getOptionToString("rad2_upper_com2_corse_up_cmd");
        Rad2UprCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_com2_corse_up_remapable.c_str());

        rad2_upper_com2_corse_dn_remapable =
            getOptionToString("rad2_upper_com2_corse_dn_cmd");
        Rad2UprCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_com2_corse_dn_remapable.c_str());

        rad2_upper_com2_fine_up_remapable =
            getOptionToString("rad2_upper_com2_fine_up_cmd");
        Rad2UprCom2FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_com2_fine_up_remapable.c_str());

        rad2_upper_com2_fine_dn_remapable =
            getOptionToString("rad2_upper_com2_fine_dn_cmd");
        Rad2UprCom2FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_com2_fine_dn_remapable.c_str());

        rad2_upper_com2_act_data_remapable =
            getOptionToString("rad2_upper_com2_act_data");
        Rad2UpperCom2ActRemapableData =
            XPLMFindDataRef(rad2_upper_com2_act_data_remapable.c_str());
    ...
    rad2uprcom2actstbybtnremap =
        getOptionToInt("Radio2 Upper Com2 ActStby remapable");
    ...
    if (rad2uprcom2actstbybtnremap == 2) {
        ...
        rad2_upr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad2_upr_com2_actstby_btn_data_off_value");
    }
    // Radio2 Upper Nav1 switch - remapable
    rad2uprnav1switchremap =
        getOptionToInt("Radio2 Upper Nav1 Switch remapable");
    if (rad2uprnav1switchremap == 1) {
        rad2_upper_obs1_corse_up_remapable =
            getOptionToString("rad2_upper_obs1_corse_up_cmd");
        Rad2UprObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_obs1_corse_up_remapable.c_str());

        rad2_upper_obs1_corse_dn_remapable =
            getOptionToString("rad2_upper_obs1_corse_dn_cmd");
        Rad2UprObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_obs1_corse_dn_remapable.c_str());

        rad2_upper_obs1_fine_up_remapable =
            getOptionToString("rad2_upper_obs1_fine_up_cmd");
        Rad2UprObs1FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_obs1_fine_up_remapable.c_str());

        rad2_upper_obs1_fine_dn_remapable =
            getOptionToString("rad2_upper_obs1_fine_dn_cmd");
        Rad2UprObs1FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_obs1_fine_dn_remapable.c_str());

        rad2_upper_obs1_remapable_dataf =
            getOptionToString("rad2_upper_obs1_dataf");
        Rad2UpperObs1RemapableDataf =
            XPLMFindDataRef(rad2_upper_obs1_remapable_dataf.c_str());


        rad2_upper_nav1_corse_up_remapable =
            getOptionToString("rad2_upper_nav1_corse_up_cmd");
        Rad2UprNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_nav1_corse_up_remapable.c_str());

        rad2_upper_nav1_corse_dn_remapable =
            getOptionToString("rad2_upper_nav1_corse_dn_cmd");
        Rad2UprNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_nav1_corse_dn_remapable.c_str());

        rad2_upper_nav1_fine_up_remapable =
            getOptionToString("rad2_upper_nav1_fine_up_cmd");
        Rad2UprNav1FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_nav1_fine_up_remapable.c_str());

        rad2_upper_nav1_fine_dn_remapable =
            getOptionToString("rad2_upper_nav1_fine_dn_cmd");
        Rad2UprNav1FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_nav1_fine_dn_remapable.c_str());

        rad2_upper_nav1_act_data_remapable =
            getOptionToString("rad2_upper_nav1_act_data");
        Rad2UpperNav1ActRemapableData =
            XPLMFindDataRef(rad2_upper_nav1_act_data_remapable.c_str());
    ...
    rad2uprnav1actstbybtnremap =
        getOptionToInt("Radio2 Upper Nav1 ActStby remapable");
    ...
    if (rad2uprnav1actstbybtnremap == 2) {
        ...
        rad2_upr_nav1_actstby_btn_data_off_value =
            getOptionToInt("rad2_upr_nav1_actstby_btn_data_off_value");
    }
    // Radio2 Upper Nav2 switch - remapable
    rad2uprnav2switchremap =
        getOptionToInt("Radio2 Upper Nav2 Switch remapable");
    if (rad2uprnav2switchremap == 1) {
        rad2_upper_obs2_corse_up_remapable =
            getOptionToString("rad2_upper_obs2_corse_up_cmd");
        Rad2UprObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_obs2_corse_up_remapable.c_str());

        rad2_upper_obs2_corse_dn_remapable =
            getOptionToString("rad2_upper_obs2_corse_dn_cmd");
        Rad2UprObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_obs2_corse_dn_remapable.c_str());

        rad2_upper_obs2_fine_up_remapable =
            getOptionToString("rad2_upper_obs2_fine_up_cmd");
        Rad2UprObs2FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_obs2_fine_up_remapable.c_str());

        rad2_upper_obs2_fine_dn_remapable =
            getOptionToString("rad2_upper_obs2_fine_dn_cmd");
        Rad2UprObs2FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_obs2_fine_dn_remapable.c_str());

        rad2_upper_obs2_remapable_dataf =
            getOptionToString("rad2_upper_obs2_dataf");
        Rad2UpperObs2RemapableDataf =
            XPLMFindDataRef(rad2_upper_obs2_remapable_dataf.c_str());


        rad2_upper_nav2_corse_up_remapable =
            getOptionToString("rad2_upper_nav2_corse_up_cmd");
        Rad2UprNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_nav2_corse_up_remapable.c_str());

        rad2_upper_nav2_corse_dn_remapable =
            getOptionToString("rad2_upper_nav2_corse_dn_cmd");
        Rad2UprNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_nav2_corse_dn_remapable.c_str());

        rad2_upper_nav2_fine_up_remapable =
            getOptionToString("rad2_upper_nav2_fine_up_cmd");
        Rad2UprNav2FnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_nav2_fine_up_remapable.c_str());

        rad2_upper_nav2_fine_dn_remapable =
            getOptionToString("rad2_upper_nav2_fine_dn_cmd");
        Rad2UprNav2FnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_nav2_fine_dn_remapable.c_str());

        rad2_upper_nav2_act_data_remapable =
            getOptionToString("rad2_upper_nav2_act_data");
        Rad2UpperNav2ActRemapableData =
            XPLMFindDataRef(rad2_upper_nav2_act_data_remapable.c_str());

        rad2_upper_nav2_stby_data_remapable =
            getOptionToString("rad2_upper_nav2_stby_data");
        Rad2UpperNav2StbyRemapableData =
            XPLMFindDataRef(rad2_upper_nav2_stby_data_remapable.c_str());

    }
    // Radio2 Upper Nav2 active stanby button - remapable
    rad2uprnav2actstbybtnremap =
        getOptionToInt("Radio2 Upper Nav2 ActStby remapable");
    ...
    if (rad2uprnav2actstbybtnremap == 2) {
        ...
        rad2_upr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad2_upr_nav2_actstby_btn_data_off_value");
    }
    ...
    if (rad2upradfswitchremap == 1) {
        ...
        Rad2UprAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad2_upper_adf_corse_up_remapable.c_str());

        rad2_upper_adf_corse_dn_remapable =
            getOptionToString("rad2_upper_adf_corse_dn_cmd");
        Rad2UprAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad2_upper_adf_corse_dn_remapable.c_str());

        rad2_upper_adf_fine_up_remapable =
            getOptionToString("rad2_upper_adf_fine_up_cmd");
        Rad2UprAdfFnUpRemapableCmd =
            XPLMFindCommand(rad2_upper_adf_fine_up_remapable.c_str());

        rad2_upper_adf_fine_dn_remapable =
            getOptionToString("rad2_upper_adf_fine_dn_cmd");
        Rad2UprAdfFnDnRemapableCmd =
            XPLMFindCommand(rad2_upper_adf_fine_dn_remapable.c_str());

        rad2_upper_adf_act_data_remapable =
            getOptionToString("rad2_upper_adf_act_data");
        Rad2UpperAdfActRemapableData =
            XPLMFindDataRef(rad2_upper_adf_act_data_remapable.c_str());
    ...
    rad2upradfactstbybtnremap =
        getOptionToInt("Radio2 Upper Adf ActStby remapable");
    if (rad2upradfactstbybtnremap == 1) {
        rad2_upper_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad2_upper_adf_actstby_btn_cmd");
        Rad2UprAdfActStbyRemapableCmd =
    ...
    if (rad2upradfactstbybtnremap == 2) {
        ...
        rad2_upr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad2_upr_adf_actstby_btn_data_off_value");
    }
    ...
    if (rad2uprxpdrswitchremap == 777) {
        rad2_upper_xpdr_data_remapable =
            getOptionToString("rad2_upper_xpdr_data");
        Rad2UpperXpdrRemapableData =
            XPLMFindDataRef(rad2_upper_xpdr_data_remapable.c_str());

        rad2_upper_xpdr_mode_remapable =
            getOptionToString("rad2_upper_xpdr_mode");
        Rad2UpperXpdrRemapableMode =
            XPLMFindDataRef(rad2_upper_xpdr_mode_remapable.c_str());

        rad2_upper_xpdr_baro_std_data_remapable =
            getOptionToString("rad2_upper_xpdr_baro_std_data");
        Rad2UpperXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad2_upper_xpdr_baro_std_data_remapable.c_str());

        rad2_upper_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad2_upper_xpdr_baro_up_cmd");
        Rad2UpperXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad2_upper_xpdr_baro_up_remapable_cmd.c_str());
    ...
    rad2lwrcom1switchremap =
        getOptionToInt("Radio2 Lower Com1 Switch remapable");
    if (rad2lwrcom1switchremap == 1) {
        rad2_lower_com1_corse_up_remapable =
            getOptionToString("rad2_lower_com1_corse_up_cmd");
        Rad2LowrCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_com1_corse_up_remapable.c_str());

        rad2_lower_com1_corse_dn_remapable =
            getOptionToString("rad2_lower_com1_corse_dn_cmd");
        Rad2LowrCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_com1_corse_dn_remapable.c_str());

        rad2_lower_com1_fine_up_remapable =
            getOptionToString("rad2_lower_com1_fine_up_cmd");
        Rad2LowrCom1FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_com1_fine_up_remapable.c_str());

        rad2_lower_com1_fine_dn_remapable =
            getOptionToString("rad2_lower_com1_fine_dn_cmd");
        Rad2LowrCom1FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_com1_fine_dn_remapable.c_str());

        rad2_lower_com1_act_data_remapable =
            getOptionToString("rad2_lower_com1_act_data");
        Rad2LowerCom1ActRemapableData =
            XPLMFindDataRef(rad2_lower_com1_act_data_remapable.c_str());
    ...
    rad2lwrcom1actstbybtnremap =
        getOptionToInt("Radio2 Lower Com1 ActStby remapable");
    ...
    if (rad2lwrcom1actstbybtnremap == 2) {
        ...
        rad2_lwr_com1_actstby_btn_data_off_value =
            getOptionToInt("rad2_lwr_com1_actstby_btn_data_off_value");
    }
    // Radio2 Lower Com2 switch - remapable
    rad2lwrcom2switchremap =
        getOptionToInt("Radio2 Lower Com2 Switch remapable");
    if (rad2lwrcom2switchremap == 1) {
        rad2_lower_com2_corse_up_remapable =
            getOptionToString("rad2_lower_com2_corse_up_cmd");
        Rad2LowrCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_com2_corse_up_remapable.c_str());

        rad2_lower_com2_corse_dn_remapable =
            getOptionToString("rad2_lower_com2_corse_dn_cmd");
        Rad2LowrCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_com2_corse_dn_remapable.c_str());

        rad2_lower_com2_fine_up_remapable =
            getOptionToString("rad2_lower_com2_fine_up_cmd");
        Rad2LowrCom2FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_com2_fine_up_remapable.c_str());

        rad2_lower_com2_fine_dn_remapable =
            getOptionToString("rad2_lower_com2_fine_dn_cmd");
        Rad2LowrCom2FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_com2_fine_dn_remapable.c_str());

        rad2_lower_com2_act_data_remapable =
            getOptionToString("rad2_lower_com2_act_data");
        Rad2LowerCom2ActRemapableData =
            XPLMFindDataRef(rad2_lower_com2_act_data_remapable.c_str());

        rad2_lower_com2_stby_data_remapable =
            getOptionToString("rad2_lower_com2_stby_data");
        Rad2LowerCom2StbyRemapableData =
            XPLMFindDataRef(rad2_lower_com2_stby_data_remapable.c_str());

    }
    // Radio2 Lower Com2 active stanby button - remapable
    rad2lwrcom2actstbybtnremap =
        getOptionToInt("Radio2 Lower Com2 ActStby remapable");
    ...
    if (rad2lwrcom2actstbybtnremap == 2) {
        ...
        rad2_lwr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad2_lwr_com2_actstby_btn_data_off_value");
    }
    // Radio2 Lower Nav1 switch - remapable
    rad2lwrnav1switchremap =
        getOptionToInt("Radio2 Lower Nav1 Switch remapable");
    if (rad2lwrnav1switchremap == 1) {
        rad2_lower_obs1_corse_up_remapable =
            getOptionToString("rad2_lower_obs1_corse_up_cmd");
        Rad2LowrObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_obs1_corse_up_remapable.c_str());

        rad2_lower_obs1_corse_dn_remapable =
            getOptionToString("rad2_lower_obs1_corse_dn_cmd");
        Rad2LowrObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_obs1_corse_dn_remapable.c_str());

        rad2_lower_obs1_fine_up_remapable =
            getOptionToString("rad2_lower_obs1_fine_up_cmd");
        Rad2LowrObs1FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_obs1_fine_up_remapable.c_str());

        rad2_lower_obs1_fine_dn_remapable =
            getOptionToString("rad2_lower_obs1_fine_dn_cmd");
        Rad2LowrObs1FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_obs1_fine_dn_remapable.c_str());

        rad2_lower_obs1_remapable_dataf =
            getOptionToString("rad2_lower_obs1_dataf");
        Rad2LowerObs1RemapableDataf =
            XPLMFindDataRef(rad2_lower_obs1_remapable_dataf.c_str());


        rad2_lower_nav1_corse_up_remapable =
            getOptionToString("rad2_lower_nav1_corse_up_cmd");
        Rad2LowrNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_nav1_corse_up_remapable.c_str());

        rad2_lower_nav1_corse_dn_remapable =
            getOptionToString("rad2_lower_nav1_corse_dn_cmd");
        Rad2LowrNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_nav1_corse_dn_remapable.c_str());

        rad2_lower_nav1_fine_up_remapable =
            getOptionToString("rad2_lower_nav1_fine_up_cmd");
        Rad2LowrNav1FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_nav1_fine_up_remapable.c_str());

        rad2_lower_nav1_fine_dn_remapable =
            getOptionToString("rad2_lower_nav1_fine_dn_cmd");
        Rad2LowrNav1FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_nav1_fine_dn_remapable.c_str());

        rad2_lower_nav1_act_data_remapable =
            getOptionToString("rad2_lower_nav1_act_data");
        Rad2LowerNav1ActRemapableData =
            XPLMFindDataRef(rad2_lower_nav1_act_data_remapable.c_str());
    ...
    rad2lwrnav1actstbybtnremap =
        getOptionToInt("Radio2 Lower Nav1 ActStby remapable");
    ...
    if (rad2lwrnav1actstbybtnremap == 2) {
        ...
        rad2_lwr_nav1_actstby_btn_data_off_value =
            getOptionToInt("rad2_lwr_nav1_actstby_btn_data_off_value");
    }
    // Radio2 Lower Nav2 switch - remapable
    rad2lwrnav2switchremap =
        getOptionToInt("Radio2 Lower Nav2 Switch remapable");
    if (rad2lwrnav2switchremap == 1) {
        rad2_lower_obs2_corse_up_remapable =
            getOptionToString("rad2_lower_obs2_corse_up_cmd");
        Rad2LowrObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_obs2_corse_up_remapable.c_str());

        rad2_lower_obs2_corse_dn_remapable =
            getOptionToString("rad2_lower_obs2_corse_dn_cmd");
        Rad2LowrObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_obs2_corse_dn_remapable.c_str());

        rad2_lower_obs2_fine_up_remapable =
            getOptionToString("rad2_lower_obs2_fine_up_cmd");
        Rad2LowrObs2FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_obs2_fine_up_remapable.c_str());

        rad2_lower_obs2_fine_dn_remapable =
            getOptionToString("rad2_lower_obs2_fine_dn_cmd");
        Rad2LowrObs2FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_obs2_fine_dn_remapable.c_str());

        rad2_lower_obs2_remapable_dataf =
            getOptionToString("rad2_lower_obs2_dataf");
        Rad2LowerObs2RemapableDataf =
            XPLMFindDataRef(rad2_lower_obs2_remapable_dataf.c_str());


        rad2_lower_nav2_corse_up_remapable =
            getOptionToString("rad2_lower_nav2_corse_up_cmd");
        Rad2LowrNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_nav2_corse_up_remapable.c_str());

        rad2_lower_nav2_corse_dn_remapable =
            getOptionToString("rad2_lower_nav2_corse_dn_cmd");
        Rad2LowrNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_nav2_corse_dn_remapable.c_str());

        rad2_lower_nav2_fine_up_remapable =
            getOptionToString("rad2_lower_nav2_fine_up_cmd");
        Rad2LowrNav2FnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_nav2_fine_up_remapable.c_str());

        rad2_lower_nav2_fine_dn_remapable =
            getOptionToString("rad2_lower_nav2_fine_dn_cmd");
        Rad2LowrNav2FnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_nav2_fine_dn_remapable.c_str());

        rad2_lower_nav2_act_data_remapable =
            getOptionToString("rad2_lower_nav2_act_data");
        Rad2LowerNav2ActRemapableData =
            XPLMFindDataRef(rad2_lower_nav2_act_data_remapable.c_str());
    ...
    rad2lwrnav2actstbybtnremap =
        getOptionToInt("Radio2 Lower Nav2 ActStby remapable");
    ...
    if (rad2lwrnav2actstbybtnremap == 2) {
        ...
        rad2_lwr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad2_lwr_nav2_actstby_btn_data_off_value");
    }
    ...
    if (rad2lwradfswitchremap == 1) {
        ...
        Rad2LowrAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad2_lower_adf_corse_up_remapable.c_str());

        rad2_lower_adf_corse_dn_remapable =
            getOptionToString("rad2_lower_adf_corse_dn_cmd");
        Rad2LowrAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_adf_corse_dn_remapable.c_str());

        rad2_lower_adf_fine_up_remapable =
            getOptionToString("rad2_lower_adf_fine_up_cmd");
        Rad2LowrAdfFnUpRemapableCmd =
            XPLMFindCommand(rad2_lower_adf_fine_up_remapable.c_str());

        rad2_lower_adf_fine_dn_remapable =
            getOptionToString("rad2_lower_adf_fine_dn_cmd");
        Rad2LowrAdfFnDnRemapableCmd =
            XPLMFindCommand(rad2_lower_adf_fine_dn_remapable.c_str());

        rad2_lower_adf_act_data_remapable =
            getOptionToString("rad2_lower_adf_act_data");
        Rad2LowerAdfActRemapableData =
            XPLMFindDataRef(rad2_lower_adf_act_data_remapable.c_str());

        rad2_lower_adf_stby_data_remapable =
            getOptionToString("rad2_lower_adf_stby_data");
        Rad2LowerAdfStbyRemapableData =
            XPLMFindDataRef(rad2_lower_adf_stby_data_remapable.c_str());

    }
    // Radio2 Lower Adf active stanby button - remapable
    rad2lwradfactstbybtnremap =
        getOptionToInt("Radio2 Lower Adf ActStby remapable");
    if (rad2lwradfactstbybtnremap == 1) {
        rad2_lower_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad2_lower_adf_actstby_btn_cmd");
        Rad2LowrAdfActStbyRemapableCmd =
    ...
    if (rad2upradfactstbybtnremap == 2) {
        ...
        rad2_lwr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad2_lwr_adf_actstby_btn_data_off_value");
    }
    ...
    if (rad2lwrxpdrswitchremap == 777) {
        rad2_lower_xpdr_data_remapable =
            getOptionToString("rad2_lower_xpdr_data");
        Rad2LowerXpdrRemapableData =
            XPLMFindDataRef(rad2_lower_xpdr_data_remapable.c_str());

        rad2_lower_xpdr_mode_remapable =
            getOptionToString("rad2_lower_xpdr_mode");
        Rad2LowerXpdrRemapableMode =
            XPLMFindDataRef(rad2_lower_xpdr_mode_remapable.c_str());

        rad2_lower_xpdr_baro_std_data_remapable =
            getOptionToString("rad2_lower_xpdr_baro_std_data");
        Rad2LowerXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad2_lower_xpdr_baro_std_data_remapable.c_str());

        rad2_lower_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad2_lower_xpdr_baro_up_cmd");
        Rad2LowrXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad2_lower_xpdr_baro_up_remapable_cmd.c_str());
    ...
    rad3uprcom1switchremap =
        getOptionToInt("Radio3 Upper Com1 Switch remapable");
    if (rad3uprcom1switchremap == 1) {
        rad3_upper_com1_corse_up_remapable =
            getOptionToString("rad3_upper_com1_corse_up_cmd");
        Rad3UprCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_com1_corse_up_remapable.c_str());

        rad3_upper_com1_corse_dn_remapable =
            getOptionToString("rad3_upper_com1_corse_dn_cmd");
        Rad3UprCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_com1_corse_dn_remapable.c_str());

        rad3_upper_com1_fine_up_remapable =
            getOptionToString("rad3_upper_com1_fine_up_cmd");
        Rad3UprCom1FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_com1_fine_up_remapable.c_str());

        rad3_upper_com1_fine_dn_remapable =
            getOptionToString("rad3_upper_com1_fine_dn_cmd");
        Rad3UprCom1FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_com1_fine_dn_remapable.c_str());

        rad3_upper_com1_act_data_remapable =
            getOptionToString("rad3_upper_com1_act_data");
        Rad3UpperCom1ActRemapableData =
            XPLMFindDataRef(rad3_upper_com1_act_data_remapable.c_str());
    ...
    rad3uprcom1actstbybtnremap =
        getOptionToInt("Radio3 Upper Com1 ActStby remapable");
    ...
    if (rad3uprcom1actstbybtnremap == 2) {
        ...
        rad3_upr_com1_actstby_btn_data_off_value =
            getOptionToInt("rad3_upr_com1_actstby_btn_data_off_value");
    }
    // Radio3 Upper Com2 switch - remapable
    rad3uprcom2switchremap =
        getOptionToInt("Radio3 Upper Com2 Switch remapable");
    if (rad3uprcom2switchremap == 1) {
        rad3_upper_com2_corse_up_remapable =
            getOptionToString("rad3_upper_com2_corse_up_cmd");
        Rad3UprCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_com2_corse_up_remapable.c_str());

        rad3_upper_com2_corse_dn_remapable =
            getOptionToString("rad3_upper_com2_corse_dn_cmd");
        Rad3UprCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_com2_corse_dn_remapable.c_str());

        rad3_upper_com2_fine_up_remapable =
            getOptionToString("rad3_upper_com2_fine_up_cmd");
        Rad3UprCom2FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_com2_fine_up_remapable.c_str());

        rad3_upper_com2_fine_dn_remapable =
            getOptionToString("rad3_upper_com2_fine_dn_cmd");
        Rad3UprCom2FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_com2_fine_dn_remapable.c_str());

        rad3_upper_com2_act_data_remapable =
            getOptionToString("rad3_upper_com2_act_data");
        Rad3UpperCom2ActRemapableData =
            XPLMFindDataRef(rad3_upper_com2_act_data_remapable.c_str());
    ...
    rad3uprcom2actstbybtnremap =
        getOptionToInt("Radio3 Upper Com2 ActStby remapable");
    ...
    if (rad3uprcom2actstbybtnremap == 2) {
        ...
        rad3_upr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad3_upr_com2_actstby_btn_data_off_value");
    }
    // Radio3 Upper Nav1 switch - remapable
    rad3uprnav1switchremap =
        getOptionToInt("Radio3 Upper Nav1 Switch remapable");
    if (rad3uprnav1switchremap == 1) {
        rad3_upper_obs1_corse_up_remapable =
            getOptionToString("rad3_upper_obs1_corse_up_cmd");
        Rad3UprObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_obs1_corse_up_remapable.c_str());

        rad3_upper_obs1_corse_dn_remapable =
            getOptionToString("rad3_upper_obs1_corse_dn_cmd");
        Rad3UprObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_obs1_corse_dn_remapable.c_str());

        rad3_upper_obs1_fine_up_remapable =
            getOptionToString("rad3_upper_obs1_fine_up_cmd");
        Rad3UprObs1FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_obs1_fine_up_remapable.c_str());

        rad3_upper_obs1_fine_dn_remapable =
            getOptionToString("rad3_upper_obs1_fine_dn_cmd");
        Rad3UprObs1FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_obs1_fine_dn_remapable.c_str());

        rad3_upper_obs1_remapable_dataf =
        ...
        Rad3UprNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_nav1_corse_up_remapable.c_str());

        rad3_upper_nav1_corse_dn_remapable =
            getOptionToString("rad3_upper_nav1_corse_dn_cmd");
        Rad3UprNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_nav1_corse_dn_remapable.c_str());

        rad3_upper_nav1_fine_up_remapable =
            getOptionToString("rad3_upper_nav1_fine_up_cmd");
        Rad3UprNav1FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_nav1_fine_up_remapable.c_str());

        rad3_upper_nav1_fine_dn_remapable =
            getOptionToString("rad3_upper_nav1_fine_dn_cmd");
        Rad3UprNav1FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_nav1_fine_dn_remapable.c_str());

        rad3_upper_nav1_act_data_remapable =
            getOptionToString("rad3_upper_nav1_act_data");
        Rad2UpperNav1ActRemapableData =
            XPLMFindDataRef(rad3_upper_nav1_act_data_remapable.c_str());

        rad3_upper_nav1_stby_data_remapable =
            getOptionToString("rad3_upper_nav1_stby_data");
        Rad3UpperNav1StbyRemapableData =
            XPLMFindDataRef(rad3_upper_nav1_stby_data_remapable.c_str());

    }
    // Radio3 Upper Nav1 active stanby button - remapable
    rad3uprnav1actstbybtnremap =
        getOptionToInt("Radio3 Upper Nav1 ActStby remapable");
    ...
    if (rad3uprnav1actstbybtnremap == 2) {
        ...
        rad3_upr_nav1_actstby_btn_data_off_value =
            getOptionToInt("rad3_upr_nav1_actstby_btn_data_off_value");
    }
    // Radio3 Upper Nav2 switch - remapable
    rad3uprnav2switchremap =
        getOptionToInt("Radio3 Upper Nav2 Switch remapable");
    if (rad3uprnav2switchremap == 1) {
        rad3_upper_obs2_corse_up_remapable =
            getOptionToString("rad3_upper_obs2_corse_up_cmd");
        Rad3UprObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_obs2_corse_up_remapable.c_str());

        rad3_upper_obs2_corse_dn_remapable =
            getOptionToString("rad3_upper_obs2_corse_dn_cmd");
        Rad3UprObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_obs2_corse_dn_remapable.c_str());

        rad3_upper_obs2_fine_up_remapable =
            getOptionToString("rad3_upper_obs2_fine_up_cmd");
        Rad2UprObs2FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_obs2_fine_up_remapable.c_str());

        rad3_upper_obs2_fine_dn_remapable =
            getOptionToString("rad3_upper_obs2_fine_dn_cmd");
        Rad3UprObs2FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_obs2_fine_dn_remapable.c_str());

        rad3_upper_obs2_remapable_dataf =
            getOptionToString("rad3_upper_obs2_dataf");
        ...
        Rad3UprNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_nav2_corse_up_remapable.c_str());

        rad3_upper_nav2_corse_dn_remapable =
            getOptionToString("rad3_upper_nav2_corse_dn_cmd");
        Rad3UprNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_nav2_corse_dn_remapable.c_str());

        rad3_upper_nav2_fine_up_remapable =
            getOptionToString("rad3_upper_nav2_fine_up_cmd");
        Rad2UprNav2FnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_nav2_fine_up_remapable.c_str());

        rad3_upper_nav2_fine_dn_remapable =
            getOptionToString("rad3_upper_nav2_fine_dn_cmd");
        Rad3UprNav2FnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_nav2_fine_dn_remapable.c_str());

        rad3_upper_nav2_act_data_remapable =
            getOptionToString("rad3_upper_nav2_act_data");
        Rad3UpperNav2ActRemapableData =
            XPLMFindDataRef(rad3_upper_nav2_act_data_remapable.c_str());
    ...
    rad3uprnav2actstbybtnremap =
        getOptionToInt("Radio3 Upper Nav2 ActStby remapable");
    ...
    if (rad3uprnav2actstbybtnremap == 2) {
        ...
        rad3_upr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad3_upr_nav2_actstby_btn_data_off_value");
    }
    ...
    if (rad3upradfswitchremap == 1) {
        ...
        Rad3UprAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad3_upper_adf_corse_up_remapable.c_str());

        rad3_upper_adf_corse_dn_remapable =
            getOptionToString("rad3_upper_adf_corse_dn_cmd");
        Rad3UprAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad3_upper_adf_corse_dn_remapable.c_str());

        rad3_upper_adf_fine_up_remapable =
            getOptionToString("rad3_upper_adf_fine_up_cmd");
        Rad3UprAdfFnUpRemapableCmd =
            XPLMFindCommand(rad3_upper_adf_fine_up_remapable.c_str());

        rad3_upper_adf_fine_dn_remapable =
            getOptionToString("rad3_upper_adf_fine_dn_cmd");
        Rad3UprAdfFnDnRemapableCmd =
            XPLMFindCommand(rad3_upper_adf_fine_dn_remapable.c_str());

        rad3_upper_adf_act_data_remapable =
            getOptionToString("rad3_upper_adf_act_data");
        Rad3UpperAdfActRemapableData =
            XPLMFindDataRef(rad3_upper_adf_act_data_remapable.c_str());
    ...
    rad3upradfactstbybtnremap =
        getOptionToInt("Radio3 Upper Adf ActStby remapable");
    if (rad3upradfactstbybtnremap == 1) {
        rad3_upper_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad3_upper_adf_actstby_btn_cmd");
        Rad3UprAdfActStbyRemapableCmd =
    ...
    if (rad3upradfactstbybtnremap == 2) {
        ...
        rad3_upr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad3_upr_adf_actstby_btn_data_off_value");
    }
    ...
    rad3uprxpdrswitchremap =
        getOptionToInt("Radio3 Upper Xpdr Switch remapable");
    if (rad3uprxpdrswitchremap == 777) {
        rad3_upper_xpdr_data_remapable =
            getOptionToString("rad3_upper_xpdr_data");
        Rad3UpperXpdrRemapableData =
            XPLMFindDataRef(rad3_upper_xpdr_data_remapable.c_str());

        rad3_upper_xpdr_mode_remapable =
            getOptionToString("rad3_upper_xpdr_mode");
        Rad3UpperXpdrRemapableMode =
            XPLMFindDataRef(rad3_upper_xpdr_mode_remapable.c_str());

        rad3_upper_xpdr_baro_std_data_remapable =
            getOptionToString("rad3_upper_xpdr_baro_std_data");
        Rad3UpperXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad3_upper_xpdr_baro_std_data_remapable.c_str());

        rad3_upper_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad3_upper_xpdr_baro_up_cmd");
        Rad3UpperXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad3_upper_xpdr_baro_up_remapable_cmd.c_str());
    ...
    rad3lwrcom1switchremap =
        getOptionToInt("Radio3 Lower Com1 Switch remapable");
    if (rad3lwrcom1switchremap == 1) {
        rad3_lower_com1_corse_up_remapable =
            getOptionToString("rad3_lower_com1_corse_up_cmd");
        Rad3LowrCom1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_com1_corse_up_remapable.c_str());

        rad3_lower_com1_corse_dn_remapable =
            getOptionToString("rad3_lower_com1_corse_dn_cmd");
        Rad3LowrCom1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_com1_corse_dn_remapable.c_str());

        rad3_lower_com1_fine_up_remapable =
            getOptionToString("rad3_lower_com1_fine_up_cmd");
        Rad3LowrCom1FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_com1_fine_up_remapable.c_str());

        rad3_lower_com1_fine_dn_remapable =
            getOptionToString("rad3_lower_com1_fine_dn_cmd");
        Rad3LowrCom1FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_com1_fine_dn_remapable.c_str());

        rad3_lower_com1_act_data_remapable =
            getOptionToString("rad3_lower_com1_act_data");
        Rad3LowerCom1ActRemapableData =
            XPLMFindDataRef(rad3_lower_com1_act_data_remapable.c_str());

        rad3_lower_com1_stby_data_remapable =
            getOptionToString("rad3_lower_com1_stby_data");
        Rad3LowerCom1StbyRemapableData =
            XPLMFindDataRef(rad3_lower_com1_stby_data_remapable.c_str());

    }
    // Radio3 Lower Com1 active stanby button - remapable
    rad3lwrcom1actstbybtnremap =
        getOptionToInt("Radio3 Lower Com1 ActStby remapable");
    ...
    if (rad3lwrcom1actstbybtnremap == 2) {
        ...
        rad3_lwr_com1_actstby_btn_data_off_value =
            getOptionToInt("rad3_lwr_com1_actstby_btn_data_off_value");
    }
    // Radio3 Lower Com2 switch - remapable
    rad3lwrcom2switchremap =
        getOptionToInt("Radio3 Lower Com2 Switch remapable");
    if (rad3lwrcom2switchremap == 1) {
        rad3_lower_com2_corse_up_remapable =
            getOptionToString("rad3_lower_com2_corse_up_cmd");
        Rad3LowrCom2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_com2_corse_up_remapable.c_str());

        rad3_lower_com2_corse_dn_remapable =
            getOptionToString("rad3_lower_com2_corse_dn_cmd");
        Rad3LowrCom2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_com2_corse_dn_remapable.c_str());

        rad3_lower_com2_fine_up_remapable =
            getOptionToString("rad3_lower_com2_fine_up_cmd");
        Rad3LowrCom2FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_com2_fine_up_remapable.c_str());

        rad3_lower_com2_fine_dn_remapable =
            getOptionToString("rad3_lower_com2_fine_dn_cmd");
        Rad3LowrCom2FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_com2_fine_dn_remapable.c_str());

        rad3_lower_com2_act_data_remapable =
            getOptionToString("rad3_lower_com2_act_data");
        Rad3LowerCom2ActRemapableData =
            XPLMFindDataRef(rad3_lower_com2_act_data_remapable.c_str());

        rad3_lower_com2_stby_data_remapable =
            getOptionToString("rad3_lower_com2_stby_data");
        Rad3LowerCom2StbyRemapableData =
            XPLMFindDataRef(rad3_lower_com2_stby_data_remapable.c_str());

    }
    // Radio3 Lower Com2 active stanby button - remapable
    rad3lwrcom2actstbybtnremap =
        getOptionToInt("Radio3 Lower Com2 ActStby remapable");
    ...
    if (rad3lwrcom2actstbybtnremap == 2) {
        ...
        rad3_lwr_com2_actstby_btn_data_off_value =
            getOptionToInt("rad3_lwr_com2_actstby_btn_data_off_value");
    }
    // Radio3 Lower Nav1 switch - remapable
    rad3lwrnav1switchremap =
        getOptionToInt("Radio3 Lower Nav1 Switch remapable");
    if (rad3lwrnav1switchremap == 1) {
        rad3_lower_obs1_corse_up_remapable =
            getOptionToString("rad3_lower_obs1_corse_up_cmd");
        Rad3LowrObs1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_obs1_corse_up_remapable.c_str());

        rad3_lower_obs1_corse_dn_remapable =
            getOptionToString("rad3_lower_obs1_corse_dn_cmd");
        Rad3LowrObs1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_obs1_corse_dn_remapable.c_str());

        rad3_lower_obs1_fine_up_remapable =
            getOptionToString("rad3_lower_obs1_fine_up_cmd");
        Rad3LowrObs1FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_obs1_fine_up_remapable.c_str());

        rad3_lower_obs1_fine_dn_remapable =
            getOptionToString("rad3_lower_obs1_fine_dn_cmd");
        Rad3LowrObs1FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_obs1_fine_dn_remapable.c_str());

        rad3_lower_obs1_remapable_dataf =
            getOptionToString("rad3_lower_obs1_dataf");
        Rad3LowerObs1RemapableDataf =
            XPLMFindDataRef(rad3_lower_obs1_remapable_dataf.c_str());



        rad3_lower_nav1_corse_up_remapable =
            getOptionToString("rad3_lower_nav1_corse_up_cmd");
        Rad3LowrNav1CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_nav1_corse_up_remapable.c_str());

        rad3_lower_nav1_corse_dn_remapable =
            getOptionToString("rad3_lower_nav1_corse_dn_cmd");
        Rad3LowrNav1CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_nav1_corse_dn_remapable.c_str());

        rad3_lower_nav1_fine_up_remapable =
            getOptionToString("rad3_lower_nav1_fine_up_cmd");
        Rad3LowrNav1FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_nav1_fine_up_remapable.c_str());

        rad3_lower_nav1_fine_dn_remapable =
            getOptionToString("rad3_lower_nav1_fine_dn_cmd");
        Rad3LowrNav1FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_nav1_fine_dn_remapable.c_str());

        rad3_lower_nav1_act_data_remapable =
            getOptionToString("rad3_lower_nav1_act_data");
        Rad3LowerNav1ActRemapableData =
            XPLMFindDataRef(rad3_lower_nav1_act_data_remapable.c_str());

        rad3_lower_nav1_stby_data_remapable =
            getOptionToString("rad3_lower_nav1_stby_data");
        Rad3LowerNav1StbyRemapableData =
            XPLMFindDataRef(rad3_lower_nav1_stby_data_remapable.c_str());

    }
    // Radio3 Lower Nav1 active stanby button - remapable
    rad3lwrnav1actstbybtnremap =
        getOptionToInt("Radio3 Lower Nav1 ActStby remapable");
    ...
    if (rad3lwrnav1actstbybtnremap == 2) {
        ...
        rad3_lwr_nav1_actstby_btn_data_off_value =
            getOptionToInt("rad3_lwr_nav1_actstby_btn_data_off_value");
    }
    // Radio3 Lower Nav2 switch - remapable
    rad3lwrnav2switchremap =
        getOptionToInt("Radio3 Lower Nav2 Switch remapable");
    if (rad3lwrnav2switchremap == 1) {
        rad3_lower_obs2_corse_up_remapable =
            getOptionToString("rad3_lower_obs2_corse_up_cmd");
        Rad3LowrObs2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_obs2_corse_up_remapable.c_str());

        rad3_lower_obs2_corse_dn_remapable =
            getOptionToString("rad3_lower_obs2_corse_dn_cmd");
        Rad3LowrObs2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_obs2_corse_dn_remapable.c_str());

        rad3_lower_obs2_fine_up_remapable =
            getOptionToString("rad3_lower_obs2_fine_up_cmd");
        Rad3LowrObs2FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_obs2_fine_up_remapable.c_str());

        rad3_lower_obs2_fine_dn_remapable =
            getOptionToString("rad3_lower_obs2_fine_dn_cmd");
        Rad3LowrObs2FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_obs2_fine_dn_remapable.c_str());

        rad3_lower_obs2_remapable_dataf =
            getOptionToString("rad3_lower_obs2_dataf");
        Rad3LowerObs2RemapableDataf =
            XPLMFindDataRef(rad3_lower_obs2_remapable_dataf.c_str());


        rad3_lower_nav2_corse_up_remapable =
            getOptionToString("rad3_lower_nav2_corse_up_cmd");
        Rad3LowrNav2CrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_nav2_corse_up_remapable.c_str());

        rad3_lower_nav2_corse_dn_remapable =
            getOptionToString("rad3_lower_nav2_corse_dn_cmd");
        Rad3LowrNav2CrsDnRemapableCmd =
            XPLMFindCommand(rad3_lower_nav2_corse_dn_remapable.c_str());

        rad3_lower_nav2_fine_up_remapable =
            getOptionToString("rad3_lower_nav2_fine_up_cmd");
        Rad3LowrNav2FnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_nav2_fine_up_remapable.c_str());

        rad3_lower_nav2_fine_dn_remapable =
            getOptionToString("rad3_lower_nav2_fine_dn_cmd");
        Rad3LowrNav2FnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_nav2_fine_dn_remapable.c_str());

        rad3_lower_nav2_act_data_remapable =
            getOptionToString("rad3_lower_nav2_act_data");
        Rad3LowerNav2ActRemapableData =
            XPLMFindDataRef(rad3_lower_nav2_act_data_remapable.c_str());

        rad3_lower_nav2_stby_data_remapable =
            getOptionToString("rad3_lower_nav2_stby_data");
        Rad3LowerNav2StbyRemapableData =
            XPLMFindDataRef(rad3_lower_nav2_stby_data_remapable.c_str());

    }
    // Radio3 Lower Nav2 active stanby button - remapable
    rad3lwrnav2actstbybtnremap =
        getOptionToInt("Radio3 Lower Nav2 ActStby remapable");
    ...
    if (rad3lwrnav2actstbybtnremap == 2) {
        ...
        rad3_lwr_nav2_actstby_btn_data_off_value =
            getOptionToInt("rad3_lwr_nav2_actstby_btn_data_off_value");
    }
    // Radio3 Lower Adf switch - remapable
    rad3lwradfswitchremap =
        getOptionToInt("Radio2 Lower Adf Switch remapable");
    if (rad3lwradfswitchremap == 1) {

        rad3_lower_adf_corse_up_remapable =
            getOptionToString("rad3_lower_adf_corse_up_cmd");
        Rad3LowrAdfCrsUpRemapableCmd =
            XPLMFindCommand(rad3_lower_adf_corse_up_remapable.c_str());

        rad3_lower_adf_corse_dn_remapable =
            getOptionToString("rad3_lower_adf_corse_dn_cmd");
        Rad3LowrAdfCrsDnRemapableCmd =
            XPLMFindCommand(rad2_lower_adf_corse_dn_remapable.c_str());

        rad3_lower_adf_fine_up_remapable =
            getOptionToString("rad3_lower_adf_fine_up_cmd");
        Rad3LowrAdfFnUpRemapableCmd =
            XPLMFindCommand(rad3_lower_adf_fine_up_remapable.c_str());

        rad3_lower_adf_fine_dn_remapable =
            getOptionToString("rad3_lower_adf_fine_dn_cmd");
        Rad3LowrAdfFnDnRemapableCmd =
            XPLMFindCommand(rad3_lower_adf_fine_dn_remapable.c_str());

        rad3_lower_adf_act_data_remapable =
            getOptionToString("rad3_lower_adf_act_data");
        Rad3LowerAdfActRemapableData =
            XPLMFindDataRef(rad3_lower_adf_act_data_remapable.c_str());

        rad3_lower_adf_stby_data_remapable =
            getOptionToString("rad3_lower_adf_stby_data");
        Rad3LowerAdfStbyRemapableData =
            XPLMFindDataRef(rad3_lower_adf_stby_data_remapable.c_str());

    }
    // Radio3 Lower Adf active stanby button - remapable
    rad3lwradfactstbybtnremap =
        getOptionToInt("Radio3 Lower Adf ActStby remapable");
    if (rad3lwradfactstbybtnremap == 1) {
        rad3_lower_adf_actstby_btn_remapable_cmd =
            getOptionToString("rad3_lower_adf_actstby_btn_cmd");
        Rad3LowrAdfActStbyRemapableCmd =
            XPLMFindCommand(rad3_lower_adf_actstby_btn_remapable_cmd.c_str());
    }
    if (rad3upradfactstbybtnremap == 2) {
        ...
        rad3_lwr_adf_actstby_btn_data_off_value =
            getOptionToInt("rad3_lwr_adf_actstby_btn_data_off_value");
    }
    ...
    rad3lwrxpdrswitchremap =
        getOptionToInt("Radio3 Lower Xpdr Switch remapable");
    if (rad3lwrxpdrswitchremap == 777) {
        rad3_lower_xpdr_data_remapable =
            getOptionToString("rad3_lower_xpdr_data");
        Rad3LowerXpdrRemapableData =
            XPLMFindDataRef(rad3_lower_xpdr_data_remapable.c_str());

        rad3_lower_xpdr_mode_remapable =
            getOptionToString("rad3_lower_xpdr_mode");
        Rad3LowerXpdrRemapableMode =
            XPLMFindDataRef(rad3_lower_xpdr_mode_remapable.c_str());

        rad3_lower_xpdr_baro_std_data_remapable =
            getOptionToString("rad3_lower_xpdr_baro_std_data");
        Rad3LowerXpdrBaroStdRemapableData =
            XPLMFindDataRef(rad3_lower_xpdr_baro_std_data_remapable.c_str());

        rad3_lower_xpdr_baro_up_remapable_cmd =
            getOptionToString("rad3_lower_xpdr_baro_up_cmd");
        Rad3LowrXpdrBaroUpRemapableCmd =
            XPLMFindCommand(rad3_lower_xpdr_baro_up_remapable_cmd.c_str());

        rad3_lower_xpdr_baro_dn_remapable_cmd =
            getOptionToString("rad3_lower_xpdr_baro_dn_cmd");
        Rad3LowrXpdrBaroDnRemapableCmd =
            XPLMFindCommand(rad3_lower_xpdr_baro_dn_remapable_cmd.c_str());
...
//  ***********************   Multi Panel Commands **************************
    ...
    if ((apbuttonremap == 1) || (apbuttonremap == 2) || (apbuttonremap == 3)) {
        ...
        ap_light_flash_remapable =
            getOptionToString("ap_light_flash_remapable_data");
        ApLightFlashRemapableData =
            XPLMFindDataRef(ap_light_flash_remapable.c_str());
    }
    ...
    if (hdgbuttonremap == 1) {
        ...
        hdg_button_data_remapable =
            getOptionToString("hdg_button_remapable_data");
        HdgButtonRemapableData =
            XPLMFindDataRef(hdg_button_data_remapable.c_str());
    }
    // hdg light - remapable
    if ((hdgbuttonremap == 1) || (hdgbuttonremap == 2)
        ...
        hdg_light_flash_remapable =
            getOptionToString("hdg_light_flash_remapable_data");
        HdgLightFlashRemapableData =
            XPLMFindDataRef(hdg_light_flash_remapable.c_str());
    }
    // nav button - remapable
    navbuttonremap = getOptionToInt("Nav Button remapable");
    if (navbuttonremap == 1) {
        nav_button_vorloc_remapable =
            getOptionToString("nav_button_vorloc_remapable_cmd");
        NavButtonVorlocRemapableCmd =
            XPLMFindCommand(nav_button_vorloc_remapable.c_str());
        nav_button_lnav_remapable =
            getOptionToString("nav_button_lnav_remapable_cmd");
        NavButtonLnavRemapableCmd =
            XPLMFindCommand(nav_button_lnav_remapable.c_str());
    } else if ((navbuttonremap == 2) || (navbuttonremap == 3)) {
        nav_button_data_vorloc_remapable =
            getOptionToString("nav_button_vorloc_remapable_data");
        NavButtonVorlocRemapableData =
            XPLMFindDataRef(nav_button_data_vorloc_remapable.c_str());
        nav_button_data_lnav_remapable =
            getOptionToString("nav_button_lnav_remapable_data");
        NavButtonLnavRemapableData =
            XPLMFindDataRef(nav_button_data_lnav_remapable.c_str());
    }
    // nav light - remapable
    if ((navbuttonremap == 1) || (navbuttonremap == 2)
        || (navbuttonremap == 3)) {
        nav_light_vorloc_remapable =
            getOptionToString("nav_light_vorloc_remapable_data");
        NavLightVorlocRemapableData =
            XPLMFindDataRef(nav_light_vorloc_remapable.c_str());
        nav_light_vorloc_flash_remapable =
            getOptionToString("nav_light_vorloc_flash_remapable_data");
        NavLightVorlocFlashRemapableData =
            XPLMFindDataRef(nav_light_vorloc_flash_remapable.c_str());

        nav_light_lnav_remapable =
            getOptionToString("nav_light_lnav_remapable_data");
        NavLightLnavRemapableData =
            XPLMFindDataRef(nav_light_lnav_remapable.c_str());
        nav_light_lnav_flash_remapable =
            getOptionToString("nav_light_lnav_flash_remapable_data");
        NavLightLnavFlashRemapableData =
            XPLMFindDataRef(nav_light_lnav_flash_remapable.c_str());
    }
    ...
    if (iasbuttonremap == 1) {
        ...
        ias_changeover_button_remapable =
            getOptionToString("ias_changeover_button_remapable_cmd");
        IasChangeoverButtonRemapableCmd =
            XPLMFindCommand(ias_changeover_button_remapable.c_str());
    } else if ((iasbuttonremap == 2) || (iasbuttonremap == 3)) {
        ias_button_data_remapable =
            getOptionToString("ias_button_remapable_data");
        IasButtonRemapableData =
            XPLMFindDataRef(ias_button_data_remapable.c_str());
        ias_changeover_button_data_remapable =
            getOptionToString("ias_changeover_button_remapable_data");
        IasChangeoverButtonRemapableData =
            XPLMFindDataRef(ias_changeover_button_data_remapable.c_str());
    }
    // ias light - remapable
    if ((iasbuttonremap == 1) || (iasbuttonremap == 2)
        ...
        ias_light_flash_remapable =
            getOptionToString("ias_light_flash_remapable_data");
        IasLightFlashRemapableData =
            XPLMFindDataRef(ias_light_flash_remapable.c_str());
    }
    ...
    if (altbuttonremap == 1) {
        ...
        alt_button_data_remapable =
            getOptionToString("alt_button_remapable_data");
        AltButtonRemapableData =
            XPLMFindDataRef(alt_button_data_remapable.c_str());
    }
    // alt light - remapable
    if ((altbuttonremap == 1) || (altbuttonremap == 2)
        ...
        alt_light_flash_remapable =
            getOptionToString("alt_light_flash_remapable_data");
        AltLightFlashRemapableData =
            XPLMFindDataRef(alt_light_flash_remapable.c_str());
    }
    // vs button - remapable
    ...
    if (vsbuttonremap == 1) {
        ...
        vs_button_data_remapable =
            getOptionToString("vs_button_remapable_data");
        VsButtonRemapableData =
            XPLMFindDataRef(vs_button_data_remapable.c_str());
    }
    // vs light - remapable
    if ((vsbuttonremap == 1) || (vsbuttonremap == 2) || (vsbuttonremap == 3)) {
        ...
        vs_light_flash_remapable =
            getOptionToString("vs_light_flash_remapable_data");
        VsLightFlashRemapableData =
            XPLMFindDataRef(vs_light_flash_remapable.c_str());
    }
    ...
    if (aprbuttonremap == 1) {
        ...
        apr_button_data_remapable =
            getOptionToString("apr_button_remapable_data");
        AprButtonRemapableData =
            XPLMFindDataRef(apr_button_data_remapable.c_str());
    }
    // apr light - remapable
    if ((aprbuttonremap == 1) || (aprbuttonremap == 2)
        ...
        apr_light_flash_remapable =
            getOptionToString("apr_light_flash_remapable_data");
        AprLightFlashRemapableData =
            XPLMFindDataRef(apr_light_flash_remapable.c_str());
    }
    ...
    if (revbuttonremap == 1) {
        ...
        rev_button_data_remapable =
            getOptionToString("rev_button_remapable_data");
        RevButtonRemapableData =
            XPLMFindDataRef(rev_button_data_remapable.c_str());
    }
    // rev light - remapable
    if ((revbuttonremap == 1) || (revbuttonremap == 2)
        ...
        rev_light_flash_remapable =
            getOptionToString("rev_light_flash_remapable_data");
        RevLightFlashRemapableData =
            XPLMFindDataRef(rev_light_flash_remapable.c_str());
    }
